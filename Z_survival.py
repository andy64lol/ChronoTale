...
def get_safe_location(location_id, default_location="camp"):
    ...
    Args:
        ...
        default_location (str): Default location ID to use if location_id is invalid

    Returns:
        dict: The location data dictionary
    """
    # This function needs access to the LOCATIONS constant
    # It will be used after LOCATIONS is defined
    global LOCATIONS
    ...
    if (
        ...
        return (
            LOCATIONS.get(default_location, {}) if isinstance(LOCATIONS, dict) else {}
        )
...
VEHICLES = {
    "bicycle": {
        ...
        "repair_requirements": {"metal_scrap": 1, "rubber": 1, "tools": 1},
    ...
    "military_humvee": {
        ...
        "craftable": False,
        "found_at": ["western military_base"],
        "repair_requirements": {
            "metal_sheet": 2,
            "tools": 1,
            "rubber": 2,
    ...
    "military_truck": {
        ...
        "military_origin": True,
        "craftable": False,
        "found_at": ["eastern military_base"],
        "repair_requirements": {
            "metal_sheet": 3,
            "tools": 1,
            "rubber": 2,
...
BUILDINGS = {
    "workshop": {
        ...
        "level": 1,
        "max_level": 3,
        "construction_requirements": {"wood": 20, "metal_scrap": 15, "tools": 1},
    ...
    "garage": {
        ...
        "level": 1,
        "max_level": 3,
        "construction_requirements": {"wood": 30, "metal_scrap": 25, "tools": 1},
        "upgrade_requirements": {
        ...
        "benefits": {
            ...
            2: {
                "vehicle_repair_bonus": 0.2,
                "vehicle_storage": 2,
                "vehicle_crafting": True,
            },
            3: {
                "vehicle_repair_bonus": 0.3,
                "vehicle_storage": 3,
                "vehicle_crafting": True,
                "military_vehicle_repair": True,
            },
        },
    ...
    "watchtower": {
        ...
        "level": 1,
        "max_level": 3,
        "construction_requirements": {"wood": 25, "metal_scrap": 10, "rope": 2},
        "upgrade_requirements": {
        ...
        "benefits": {
            ...
            3: {
                "detection_range": 3,
                "defense_bonus": 0.3,
                "distant_scouting": True,
                "zombie_migration_tracking": True,
            },
        },
    ...
    "armory": {
        ...
        "benefits": {
            ...
            2: {
                "weapon_storage": 20,
                "ammo_crafting_bonus": 0.2,
                "weapon_repair": True,
            },
            3: {
                "weapon_storage": 30,
                "ammo_crafting_bonus": 0.3,
                "weapon_repair": True,
                "military_maintenance": True,
            },
        },
...
# Game constants
# Save file paths - Reuse SAVES_FOLDER from above
...
ITEMS = {
    ...
    "police_baton": {
        ...
        "damage": 18,
        "durability": 70,
        "dismantle_yield": {"metal_bar": 1, "cloth": 1},
    ...
    "taser": {
        ...
        "damage": 12,
        "durability": 15,
        "dismantle_yield": {"electronics": 1, "metal_scrap": 1, "small_iron_piece": 1},
    ...
    "prison_shank": {
        ...
        "damage": 15,
        "durability": 20,
        "craft_recipe": {"metal_scrap": 1, "cloth": 1},
        "dismantle_yield": {"metal_scrap": 1},
    ...
    "molotov": {
        ...
        "durability": 1,
        "aoe": True,
        "craft_recipe": {"glass_bottle": 1, "fuel": 1, "cloth": 1},
        "dismantle_yield": {"glass_bottle": 1, "fuel": 0.5},
    ...
    "spear": {
        ...
        "durability": 45,
        "reach": 2,
        "craft_recipe": {"wood": 1, "metal_pipe": 1, "kitchen_knife": 1, "cloth": 2},
        "dismantle_yield": {"wood": 1, "metal_pipe": 1, "metal_scrap": 1, "cloth": 1},
    ...
    "reinforced_bat": {
        ...
        "damage": 30,
        "durability": 70,
        "craft_recipe": {"baseball_bat": 1, "nails": 15, "metal_scrap": 3, "cloth": 2},
        "dismantle_yield": {"baseball_bat": 1, "nails": 8, "metal_scrap": 2},
    ...
    "shotgun_shell": {
        ...
        "count": 6,
        "craft_recipe": {"gunpowder": 6, "metal_scrap": 8, "primer": 1, "tools": 1},
    ...
    "crossbow_bolt": {
        ...
        "crafting_requirements": {"metal_scrap": 1, "duct_tape": 1, "wood": 1},
    ...
    "fuel_canister": {
        ...
        "craftable": True,
        "weapon": "flamethrower",
        "crafting_requirements": {"fuel": 3, "alcohol": 1, "duct_tape": 1},
    ...
    "battery_pack": {
        ...
        "crafting_requirements": {"electronics": 2, "metal_scrap": 1, "wire": 2},
    ...
    "carbon_fiber_bolts": {
        ...
        "crafting_requirements": {"metal_scrap": 1, "wood": 1, "duct_tape": 1},
...
SURVIVOR_TYPES = {
    "hostile_bandit": {
        ...
        "dialogue": {
            "greeting": [
                ...
                "Hand over your supplies and nobody gets hurt!",
                "One more step and you're dead!",
            ],
            "aggressive": [
                "I'm gonna enjoy taking your stuff!",
                "Should've just walked away!",
                "Time to die, fresh meat!",
            ],
            "retreat": [
                "This isn't worth it! I'm out!",
                "Too much heat! Falling back!",
    ...
    "cautious_survivor": {
        ...
        "dialogue": {
            "greeting": [
                "Stay where you are! I'm not looking for trouble.",
                "Who are you? What do you want?",
                "I've got nothing worth taking, so please just move along.",
            ],
            "friendly": [
                "Maybe we can help each other out.",
                "I've got some medical training if you need it.",
                "I know where to find supplies if we work together.",
            ],
            "joining": [
                "Strength in numbers, I guess.",
                "I'll join you, but I'm watching my back.",
                "I can contribute to your group if you'll have me.",
            ],
        },
    },
    "friendly_trader": {
        ...
        "dialogue": {
            "greeting": [
                ...
                "Ah, another survivor! I've got goods if you've got something to barter with.",
                "Well met, friend! Care to see my wares?",
            ],
            "trade": [
                "I've got some special items you won't find easily.",
                "These medical supplies will cost you, but they're worth it.",
                "Information has value too - I can mark locations on your map for the right price.",
            ],
            "joining": [
                "Travel with you? Well, having protection would be nice...",
                "I suppose my trading network could benefit your group.",
                "I'll join you, but I expect to continue my trading operations.",
            ],
        },
    },
    "skilled_hunter": {
        ...
        "dialogue": {
            "greeting": [
                "Freeze. Been tracking you for half a mile.",
                "You're making enough noise to attract every infected in the county.",
                "Hmm, you're not infected. That's something at least.",
            ],
            "friendly": [
                "I know where all the game trails are. Never go hungry with me around.",
                "I can teach you to move without being heard.",
                "The infected can't track what they can't see or smell.",
            ],
            "joining": [
                "The lone hunter routine gets old. Might be nice to hunt with a pack again.",
                "I'll join, but when we're in the wild, you follow my lead.",
                "I can keep your group fed and safe in the wilderness.",
            ],
        },
    },
    "military_veteran": {
        ...
        "dialogue": {
            "greeting": [
                ...
                "Hands where I can see them. Standard procedure.",
            ],
            "friendly": [
                "My unit was overrun during the early days. Been solo ever since.",
                "I've got combat training that could help your group survive.",
                "Military discipline is what keeps people alive in this hellscape.",
            ],
            "joining": [
                "Your group could use some proper tactical training.",
                "I'll join, but we need clear protocols and chain of command.",
                "Roger that. Consider me your new security specialist.",
            ],
        },
    },
    "engineering_expert": {
        ...
        "dialogue": {
            "greeting": [
                "Don't shoot! I'm more valuable alive than dead!",
                "I could fix that weapon you're pointing at me. Looks misaligned.",
                "Engineering solution: Neither of us wants violence, so let's cooperate.",
            ],
            "friendly": [
                "I can modify your equipment to work 30% more efficiently.",
                "That vehicle of yours? I could double its fuel efficiency.",
                "Give me some parts and I can build defenses that will keep the infected out.",
            ],
            "joining": [
                "Your group needs technical expertise. I'm it.",
                "I'll join if I get space to set up a workshop.",
                "Together we can build something that lasts in this broken world.",
            ],
        },
    },
}
...
class GameState:
    ...
    def __init__(self):
        ...
        # Initialize nearby_enemies list for area effect weapons
        self.nearby_enemies = []
        ...
        self.commands = {
            ...
            "/equip": {
                "func": self.cmd_equip,
                "help": "Equip a weapon. Usage: /equip [item_id]",
            },
            "/use": {
                "func": self.cmd_use,
                "help": "Use an item. Usage: /use [item_id]",
            },
            "/look": {
                "func": self.cmd_look,
                "help": "Look around your current location",
            },
            "/go": {
                "func": self.cmd_go,
                "help": "Travel to a location. Usage: /go [location]",
            },
            "/explore": {
                "func": self.cmd_explore,
                "help": "Explore the area for resources",
            },
            "/rest": {
                "func": self.cmd_rest,
                "help": "Rest to recover stamina. Usage: /rest [hours]",
            },
            "/attack": {"func": self.cmd_attack, "help": "Attack a zombie (in combat)"},
            "/flee": {"func": self.cmd_flee, "help": "Try to escape from combat"},
            "/craft": {
                "func": self.cmd_craft,
                "help": "Craft items from materials. Usage: /craft",
            },
            "/drop": {
                "func": self.cmd_drop,
                "help": "Drop an item from inventory. Usage: /drop [item_id]",
            },
            "/scavenge": {
                "func": self.cmd_scavenge_area,
                "help": "Scavenge your current location for resources. Usage: /scavenge",
            },
            "/sleep": {
                "func": self.cmd_sleep,
                "help": "Sleep to recover energy until dawn (default) or for specific hours. Usage: /sleep [hours|dawn]",
            },
            "/eat": {
                "func": self.cmd_eat,
                "help": "Eat food to reduce hunger. Usage: /eat [item_id]",
            },
            "/missions": {
                "func": self.cmd_missions,
                "help": "Show active and available missions",
            },
            "/map": {
                "func": self.cmd_map,
                "help": "Display a map of available locations",
            },
            "/stats": {
                "func": self.cmd_stats,
                "help": "Show detailed player statistics",
            },
            "/time": {
                "func": self.cmd_time,
                "help": "Display current game time and date",
            },
            "/companions": {
                "func": self.cmd_companions,
                "help": "View and manage your companions",
            },
            "/dismiss": {
                "func": self.cmd_dismiss,
                "help": "Dismiss a companion from your group. Usage: /dismiss [companion_name]",
            },
            "/boss": {
                "func": self.cmd_boss,
                "help": "Information about boss zombies you've encountered",
            },
            "/weather": {
                "func": self.cmd_weather,
                "help": "Check the current weather conditions",
            },
            "/deathlog": {
                "func": self.cmd_deathlog,
                "help": "View the death log (hardcore mode)",
            },
            "/upgrade_camp": {
                "func": self.cmd_upgrade_camp,
                "help": "View or upgrade camp facilities",
            },
            "/repair_barricades": {
                "func": self.cmd_repair_barricades,
                "help": "Repair damaged camp barricades",
            },
            "/dismantle": {
                "func": self.cmd_dismantle,
                "help": "Break down an item into its components. Usage: /dismantle [item_id]",
            },
            "/save": {
                "func": self.cmd_save,
                "help": "Save your game progress to a slot (1-5). Usage: /save [slot]",
            },
            "/load": {
                "func": self.cmd_load,
                "help": "Load a saved game from a slot (1-5). Usage: /load [slot]",
            },
            "/saves_list": {
                "func": self.cmd_saves_list,
                "help": "Show all available save slots",
            },
    ...
    def cmd_deathlog(self, *args):
        ...
        print(
            Colors.colorize(
                f"\nTotal Deaths Recorded: {self.death_log['total_deaths']}",
        ...
        sorted_deaths = sorted(
            self.death_log["deaths"],
            key=lambda x: x.get("days_survived", 0),
            reverse=True,
        )
        ...
        for i, death in enumerate(sorted_deaths[:5]):  # Show top 5
            print(
                f"{i+1}. {Colors.colorize(death['name'], Colors.GREEN)} - "
        ...
        for i, death in enumerate(reversed(sorted_deaths[-5:])):  # Show latest 5
            print(
                f"{i+1}. {Colors.colorize(death['name'], Colors.YELLOW)} - "
        ...
        print(
            Colors.colorize(
                "\nEvery death is a story in the apocalypse. What will yours be?",
                Colors.MAGENTA,
            )
        )
    ...
    def _display_game_intro(self):
        ...
        title += "\n" + Colors.colorize(
            "ZOMBIE SURVIVAL RPG".center(70), Colors.BOLD + Colors.RED
        )
    ...
    def _display_save_slots(self):
        ...
        if save_slots:
            ...
            for save in save_slots:
                self._display_single_save_slot(save)
        else:
    ...
    def _display_single_save_slot(self, save):
        ...
        Args:
            save (dict): Dictionary containing save data
        """
        if not save or not isinstance(save, dict):
            return
            
        slot_header = f"Slot {save.get('slot', '?')}:"
        print(Colors.colorize(slot_header, Colors.BOLD + Colors.GREEN))

        # Display character info with colors
        character_info = (
            f"Survivor: {Colors.colorize(save.get('name', 'Unknown'), Colors.YELLOW)}, "
        )
        character_info += (
            f"Level {Colors.colorize(str(save.get('level', 1)), Colors.YELLOW)} "
        )
        character_info += f"({Colors.colorize(str(save.get('days_survived', 0)), Colors.RED)} days survived)"
        print(character_info)

        # Display location with cyan color - with null safety
        location_key = save.get('location', 'shelter')
        location_name = "Unknown"
        if location_key in LOCATIONS and isinstance(LOCATIONS[location_key], dict):
            location_name = LOCATIONS[location_key].get('name', 'Unknown Location')
        location_info = f"Location: {Colors.colorize(location_name, Colors.CYAN)}"
        print(location_info)

        # Display save date with purple color
        saved_date = save.get("saved_date", 0)
        date_str = datetime.fromtimestamp(saved_date).strftime(
            "%Y-%m-%d %H:%M:%S"
        )
        print(f"Saved: {Colors.colorize(date_str, Colors.MAGENTA)}")
        print()  # Add space after each slot
        print(Colors.colorize(
            "Start a new game and use /save [slot] to create your first save.",
            Colors.CYAN
        ))

        # Calculate empty slots
        save_slots = self.get_save_slots()  # Ensure save_slots is defined
        ...
        divider = "=" * 50  # Define divider variable
        print(Colors.colorize(f"\n{divider}", Colors.RED))
        # This is the key prompt that needs to appear for every player at startup
        load_option = input(
            Colors.colorize("Load a saving file? (y/n): ", Colors.BOLD + Colors.GREEN)
        )
                ...
                try:
                    ...
                    if any(save["slot"] == slot for save in save_slots):
                        ...
                        Animations.loading_bar(
                            length=20, message=f"Loading save from slot {slot}"
                        )
                        self.load_game(slot)
                        ...
                        print(
                            Colors.colorize(
                                f"Save slot {slot} does not exist. Please choose from the available slots.",
                                Colors.RED,
                            )
                        )
                except ValueError:
        ...
        while not self.player["name"]:
            ...
            hardcore_warning = "\n" + Colors.colorize(
                "=== HARDCORE MODE ===", Colors.BOLD + Colors.RED
            )
            hardcore_warning += "\n" + Colors.colorize("Features:", Colors.YELLOW)
            hardcore_warning += (
                "\n- "
                + Colors.colorize("PERMADEATH", Colors.RED)
                + ": Save file deleted on death"
            )
            hardcore_warning += (
                "\n- "
                + Colors.colorize("Status Effects", Colors.RED)
                + ": Bleeding, Infection, Broken Limbs"
            )
            hardcore_warning += (
                "\n- "
                + Colors.colorize("Mental Health System", Colors.MAGENTA)
                + ": Insanity affects gameplay"
            )
            hardcore_warning += (
                "\n- "
                + Colors.colorize("Limited Resources", Colors.YELLOW)
                + ": Reduced health/stat caps"
            )
            hardcore_warning += (
                "\n- "
                + Colors.colorize("Faster Deterioration", Colors.YELLOW)
                + ": Stats decrease faster"
            )
            hardcore_warning += (
                "\n- "
                + Colors.colorize("Advanced Combat", Colors.RED)
                + ": Weapon effects, critical hits"
            )
            print(hardcore_warning)

            hardcore_option = input(
                Colors.colorize(
            ...
            if self.player["hardcore_mode"]:
                ...
                Animations.loading_bar(
                    length=15, message="Initializing hardcore survival parameters"
                )
                print(
                    Colors.colorize(
                        "\nYou've chosen the path of greater challenge and immersion.",
                        Colors.YELLOW,
                    )
                )
                print(
                    Colors.colorize(
                        "Every decision you make will have more significant consequences.",
                        Colors.YELLOW,
                    )
                )
            else:
                ...
                print(
                    Colors.colorize(
                        "You'll face challenges, but without the more punishing mechanics.",
                        Colors.YELLOW,
                    )
                )
        ...
        while self.game_running:
            try:
                ...
                if not command.startswith("/"):
                    print(
                        Colors.colorize(
                            "Commands must start with / (e.g., /help)", Colors.YELLOW
                        )
                    )
                    continue
    ...
    def advance_time(self, command_type, hours=None):
        ...
        if current_weather == "stormy" and command_type in [
            "medium_action",
            "heavy_action",
        ]:
            ...
            print(
                Colors.colorize(
                    "The storm slows your progress significantly.", Colors.BLUE
                )
            )
        elif current_weather == "rainy" and command_type in [
            "medium_action",
            "heavy_action",
        ]:
            ...
            print(
                Colors.colorize(
                    "The rain makes your task take longer than usual.", Colors.BLUE
                )
            )
        ...
        if hours_passed > 0:
            ...
            if self.player["hours_passed"] >= 24:
                ...
                if days == 1:
                    print(
                        Colors.colorize(
                            f"A new day dawns... Day {self.player['days_survived']}",
                            Colors.YELLOW,
                        )
                    )
                else:
                    print(
                        Colors.colorize(
                            f"{days} days pass... Now on Day {self.player['days_survived']}",
                            Colors.YELLOW,
                        )
                    )
            ...
            time_period = (
                "night" if is_night else "dawn/dusk" if is_dawn_dusk else "daytime"
            )
            time_color = (
                Colors.BLUE
                if is_night
            ...
            if is_night:
                print(
                    Colors.colorize(
                        f"It's now {current_hour}:00 - {time_period.upper()}. Zombies are more dangerous!",
                        time_color,
                    )
                )
            else:
                print(
                    Colors.colorize(
                        f"It's now {current_hour}:00 - {time_period}.", time_color
                    )
                )
    ...
    def update_weather(self):
        ...
        self.player["weather_duration"] = max(
            0, self.player.get("weather_duration", 0) - 1
        )
        ...
        if self.player["weather_duration"] <= 0:
            ...
            if old_weather == "clear":
                ...
                weights = [
                    ...
                    0.2,
                    0.0,
                ]  # Storm usually transitions to rain
            else:
            ...
            if old_weather != new_weather:
                ...
                print(
                    Colors.colorize(
                        f"\nThe weather has changed to {symbol} {weather_info['name']}!",
                        color,
                    )
                )
                ...
                if new_weather == "stormy":
                    print(
                        Colors.colorize(
                            "Warning: The thunderstorm will make travel dangerous!",
                            Colors.RED,
                        )
                    )
                    ...
                    print(
                        Colors.colorize(
                            "Warning: The heat wave will increase your thirst!",
                            Colors.RED,
                        )
                    )
                    ...
                    print(
                        Colors.colorize(
                            "Warning: The cold snap will increase your hunger!",
                            Colors.RED,
                        )
                    )
    ...
    def update_game_time(self):
        ...
        hours = int(
            self.player["hours_passed"] % 24
        )  # Convert to integer to ensure formatting works
        ...
        if current_weather in WEATHER_TYPES:
            ...
            time_display += (
                f" | {Colors.colorize(f'{symbol} {weather_name}', weather_color)}"
            )
    ...
    def save_game(self, slot=None):
        ...
        if slot is None:
            ...
            if save_slots:
                print("\nExisting save slots:")
                for save in save_slots:
                    date_str = datetime.fromtimestamp(save["saved_date"]).strftime(
                        "%Y-%m-%d %H:%M"
                    )
                    print(
                        f"  {save['slot']}. {save['name']} (Level {save['level']}, {save['days_survived']} days, {save['location']}) - {date_str}"
                    )

            # Calculate available slots
            used_slots = [save["slot"] for save in save_slots]
            available_slots = [
                i for i in range(1, MAX_SAVE_SLOTS + 1) if i not in used_slots
            ]
        ...
        if os.path.exists(slot_file):
            confirmation = input(
                f"Save slot {slot} already exists. Overwrite? (y/n): "
            ).lower()
            if confirmation != "y":
                print("Save cancelled.")
                return False
    ...
    def record_death(self, cause):
        ...
        print(
            Colors.colorize(
                f"Days Survived: {death_record['days_survived']}", Colors.YELLOW
            )
        )
        print(Colors.colorize(f"Level Reached: {death_record['level']}", Colors.YELLOW))
        print(
            Colors.colorize(
                f"Zombies Killed: {death_record['zombies_killed']}", Colors.YELLOW
            )
        )
        print(
            Colors.colorize(
                f"Final Resting Place: {death_record['location']}", Colors.MAGENTA
            )
        )
        print(
            Colors.colorize(
                "\nYour story will be remembered in the annals of the apocalypse.",
    ...
    def add_to_inventory(self, item_id, count=1):
        ...
        if base_item.get("type") in ["ammo", "material", "food"] and count > 0:
            for inv_item in self.player["inventory"]:
                if (
                    inv_item["id"] == item_id
                    and len(self.player["inventory"]) < MAX_INVENTORY_SLOTS
                ):
    ...
    def spawn_zombie(self, specific_boss=None, specific_type=None):
        ...
        # Use the safe location helper function
        location_id = self.player.get(
            "location", "camp"
        )  # Default to camp if no location
        location = get_safe_location(location_id, "camp")
        danger = location.get(
            "danger_level", 5
        )  # Default danger level if not specified
        ...
        # Check if we need to spawn a specific boss for a mission
            ...
            if specific_boss in BOSS_ZOMBIES:
                ...
                zombie = {
                    ...
                    "description": boss_data.get(
                        "description", "A powerful zombie boss."
                    ),
                }
        ...
        zombie_types = [
            z_type
            for z_type in ZOMBIE_TYPES.keys()
            if not ZOMBIE_TYPES[z_type].get("is_boss", False)
        ]  # Filter out boss zombies
        ...
        if location_id == "military_base":
            ...
            # Define custom weights for military base zombies
            custom_weights = {
            ...
            # Use custom weights for military base
            weights = []
            for z_type in zombie_types:
                if z_type in custom_weights:
                    weights.append(custom_weights[z_type])
                else:
                    weights.append(1)  # Default weight for types not specified

            # Select zombie type based on weights
            selected_type = random.choices(zombie_types, weights=weights, k=1)[0]
            return self.spawn_zombie(selected_type)

        # For other locations, use standard weights
        weights = []
        ...
        for z_type in zombie_types:
            ...
            if z_type == "walker":
                ...
                base_weight = min(
                    danger + 1, 5
                )  # Runners more common in dangerous areas
                if is_night:
                    base_weight += 2  # Runners very active at night
            elif z_type == "brute":
                base_weight = (
                    min(danger - 1, 4) if danger > 2 else 0
                )  # Brutes only in dangerous areas
            elif z_type == "spitter":
                base_weight = (
                    min(danger - 2, 3) if danger > 3 else 0
                )  # Spitters only in very dangerous areas
                if is_night:
        ...
        for mission_id in self.player["active_missions"]:
            if mission_id in MISSIONS:
                ...
                if event_type == "location" and data == mission["location"]:
                    ...
                    if (
                        "Forest Stalker" in mission["objective"]
    ...
    def check_new_missions(self):
        ...
        active_and_completed = (
            self.player["active_missions"] + self.player["completed_missions"]
        )
    ...
    def cmd_status(self, *args):
        ...
        if p.get("hardcore_mode", False):
            hardcore_indicator = Colors.colorize(
                " [HARDCORE MODE] ", Colors.BOLD + Colors.RED
            )
        ...
        days_display = (
            f"Days Survived: {Colors.colorize(str(p['days_survived']), Colors.YELLOW)}"
        )
        ...
        stamina_display = (
            f"Stamina: {p['stamina']}/{p['max_stamina']} ({stamina_status})"
        )
        ...
        thirst_status = (
            "Hydrated"
            if thirst_percent > 70
            else "Thirsty"
            if thirst_percent > 30
            else "Dehydrated"
        )
        ...
        print(
            f"Location: {Colors.colorize(location_name, Colors.CYAN)} (Danger: {danger_display})"
        )
        print(
            f"Zombies Killed: {Colors.colorize(str(p['zombies_killed']), Colors.RED)}"
        )
        ...
        if p.get("hardcore_mode", False):
            ...
            if p.get("exhaustion", 0) > 50:
                print(
                    Colors.colorize(
                        f"  ✗ Exhaustion ({p['exhaustion']}%)", Colors.YELLOW
                    )
            ...
            if p.get("insanity", 0) > 30:
                print(
                    Colors.colorize(
                        f"  ✗ Mental Stress ({p['insanity']}%)", Colors.MAGENTA
                    )
            ...
            if not any(
                [
                    p.get("bleeding", False),
                    p.get("infected", False),
                    p.get("broken_limb", False),
                    p.get("exhaustion", 0) > 50,
                    p.get("insanity", 0) > 30,
                ]
            ):
                print(
                    Colors.colorize("  ✓ Healthy", Colors.GREEN)
        ...
        if p["equipped_weapon"] is not None:
            ...
            if "ammo" in weapon:
                ...
                print(
                    Colors.colorize(
                        f"  Ammo: {weapon['ammo']}/{weapon['max_ammo']}", ammo_color
                    )
                )
    ...
    def cmd_inventory(self, *args):
        ...
        for i, item in enumerate(self.player["inventory"]):
            ...
            if item["type"] == "weapon":
                print(
                    f"   Damage: {item['damage']}  Durability: {item['durability']}/100"
                )
                if "ammo" in item:
                ...
                if item["type"] == "food" or item["type"] == "medical":
                    ...
                    if "stamina" in item:
                        ...
                        self.player["stamina"] = min(
                            self.player["stamina"] + item["stamina"],
                    ...
                    if "hunger" in item:
                        ...
                        self.player["hunger"] = min(
                            self.player["hunger"] + item["hunger"],
                    ...
                    if "thirst" in item:
                        ...
                        self.player["thirst"] = min(
                            self.player["thirst"] + item["thirst"],
                    ...
                    for _, inv_item in enumerate(
                        ...
                        if inv_item.get("id") == weapon_type:
                            ...
                            if ammo_to_add > 0:
                                ...
                                print(
                                    f"Loaded {ammo_to_add} rounds into {inv_item['name']}."
                                )
                                ...
                                if ammo_to_add >= item["count"]:
                                    ...
                                    print(
                                        f"{item['count']} rounds remaining in inventory."
                                    )
                                ...
                                print(
                                    f"The {inv_item['name']} is already fully loaded."
                                )
                                weapon_found = True
                                break
                    ...
                    if not weapon_found:
                        print(
                            f"You don't have a {weapon_type.replace('_', ' ')} to use this ammunition with."
                        )
    ...
    def cmd_look(self, *args):
        ...
        print(
            location.get(
                "description", "A nondescript area with no distinguishing features."
            )
        )

        danger_level = location.get("danger_level", 0)
        print(f"Danger Level: {danger_level} {'🧟' * danger_level}")

        # Show available resources with safety checks
        print("\nPotential Resources:")
        resource_types = location.get("resource_types", [])
        if resource_types:
            for resource in resource_types:
                print(f"- {resource.capitalize()}")
        else:
            print("- No resources available in this area.")

        # Show available exits with safety checks
        print("\nAvailable Locations:")
        current_location_id = self.player.get("location", "camp")
        available_locations = False

        # Make sure LOCATIONS exists and is a dict
        if isinstance(LOCATIONS, dict):
            for loc_id, loc_data in LOCATIONS.items():
                if loc_id != current_location_id:
                    loc_name = loc_data.get("name", f"Unknown Area ({loc_id})")
                    print(f"- {loc_name} (/go {loc_id})")
                    available_locations = True

        if not available_locations:
            print("- No other locations available at this time.")
    ...
    def update_survival_stats(self, hours=1):
        ...
        if self.player["hunger"] > 20 and self.player["thirst"] > 20:
            stamina_gain = min(
                int(
                    hours * 3 * TIME_FACTOR * stamina_modifier
                ),  # use stamina_modifier here
        ...
        if hunger_modifier > 1.0 or thirst_modifier > 1.0:
            if current_weather == "hot":
                print(
                    Colors.colorize(
                        "The heat is making you dehydrate faster.", Colors.RED
                    )
                )
            elif current_weather == "cold":
                print(
                    Colors.colorize(
                        "The cold makes you burn calories faster to stay warm.",
                        Colors.BLUE,
                    )
                )
        ...
        if old_sleep > 30 and self.player["sleep"] <= 30:
            print(
                Colors.colorize(
                    "\n⚠️ You're starting to feel tired. Get some sleep soon.",
                    Colors.YELLOW,
                )
            )
        ...
        if self.player["hunger"] <= 0:
            ...
            if hardcore_mode:
                ...
                self.player["insanity"] = min(
                    100, self.player.get("insanity", 0) + insanity_gain
                )
                if insanity_gain > 0:
                    print(
                        Colors.colorize(
                            "  Your mental state is deteriorating from starvation...",
                            Colors.MAGENTA,
                        )
                    )
        ...
        if self.player["thirst"] <= 0:
            ...
            print(
                Colors.colorize(
                    "\n❗ You are dehydrated! Your health is decreasing rapidly.",
                    Colors.RED,
                )
            )
            ...
            if hardcore_mode:
                ...
                if insanity_gain > 0:
                    print(
                        Colors.colorize(
                            "  Your mind is clouding from severe dehydration...",
                            Colors.MAGENTA,
                        )
                    )
        ...
        if hardcore_mode:
            ...
            if self.player.get("bleeding", False):
                ...
                if random.random() < 0.1 * hours:
                    ...
                    print(
                        Colors.colorize(
                            "  The bleeding has stopped naturally.", Colors.GREEN
                        )
                    )
            ...
            if self.player.get("infected", False):
                ...
                print(
                    Colors.colorize(
                        f"\n❗ Your infection is worsening! (-{infection_damage} health)",
                        Colors.RED,
                    )
                )
                ...
                if random.random() < 0.05 * hours:
                    ...
                    print(
                        Colors.colorize(
                            "  Your immune system has fought off the infection.",
                            Colors.GREEN,
                        )
                    )
            ...
            if self.player.get("broken_limb", False):
                ...
                if random.random() < 0.02 * hours:
                    ...
                    print(
                        Colors.colorize(
                            "\n  Your broken limb has healed enough for normal movement.",
                            Colors.GREEN,
                        )
                    )
            ...
            if self.player.get("exhaustion", 0) > 0:
                ...
                self.player["exhaustion"] = max(
                    0, self.player.get("exhaustion", 0) - exhaustion_recovery
                )
            ...
            if (
                self.player.get("insanity", 0) > 0
                and self.player["hunger"] > 60
                and self.player["thirst"] > 60
            ):
                insanity_recovery = int(hours * 1)
                self.player["insanity"] = max(
                    0, self.player.get("insanity", 0) - insanity_recovery
                )
        ...
        if current_weather == "stormy":
            ...
            if random.random() < 0.3:
                print(
                    Colors.colorize(
                        "The storm is making rest difficult and slowing your recovery.",
                        Colors.BOLD + Colors.BLUE,
                    )
                )
            ...
            if random.random() < 0.3:
                print(
                    Colors.colorize(
                        "The oppressive heat makes it hard to recover your energy.",
                        Colors.RED,
                    )
                )
        elif current_weather == "cold":
            ...
            if random.random() < 0.3:
                print(
                    Colors.colorize(
                        "The cold is sapping your energy, making recovery slower.",
                        Colors.BLUE,
                    )
                )
        ...
        if self.player["hunger"] > 20 and self.player["thirst"] > 20:
            stamina_gain = min(
                int(hours * 3 * TIME_FACTOR * regen_modifier),
                self.player["max_stamina"] - self.player["stamina"],
            )
            if stamina_gain > 0:
                self.player["stamina"] += stamina_gain
                ...
                if current_weather == "clear" and random.random() < 0.2:
                    ...
                    if bonus > 0:
                        ...
                        print(
                            Colors.colorize(
                                "The pleasant weather gives you a small energy boost.",
                                Colors.GREEN,
                            )
                        )
    ...
    def cmd_sleep(self, *args):
        ...
        if args:
            try:
                ...
                if args[0].lower() == "dawn" or args[0].lower() == "day":
                    ...
                    print(
                        "Please specify a valid number of hours between 1 and 24 or 'dawn'."
                    )
                    return
        ...
        if (
            ...
            and location_info.get("barricades_intact") is False
        ):
            sleep_safety = 0.4  # 40% safe if barricades are broken
            print(
                Colors.colorize(
                    "Warning: The camp barricades are damaged, making sleep riskier.",
                    Colors.YELLOW,
                )
            )
        else:
            sleep_safety = location_info.get(
                "sleep_safety", 0.5
        ...
        stamina_recovery = min(
            hours * 10 * rest_quality_modifier,
            self.player["max_stamina"] - self.player["stamina"],
        )
        ...
        if sleep_until_dawn and random.random() < wake_early_chance:
            ...
            if early_wake < hours:
                ...
                print(
                    Colors.colorize(
                        f"\nYou wake up naturally {early_wake} hour(s) before dawn.",
                        Colors.CYAN,
                    )
                )
        ...
        print(
            Colors.colorize(
                f"\nYou slept for {actual_hours} hours and recovered {stamina_recovery:.0f} stamina.",
                Colors.GREEN,
            )
        )
        ...
        if sleep_recovery > 0:
            ...
            print(
                Colors.colorize(
                    f"Your sleep meter improved by {sleep_gain:.0f} points.",
                    Colors.GREEN,
                )
            )
        ...
        if current_location == "camp" and CAMP_UPGRADES["shelter"]["level"] > 1:
            health_recovery = min(
                hours * CAMP_UPGRADES["shelter"]["level"],
                self.player["max_health"] - self.player["health"],
            )
            self.player["health"] += health_recovery
            print(
                Colors.colorize(
                    f"Your comfortable shelter helped you heal. Recovered {health_recovery:.0f} health.",
                    Colors.GREEN,
                )
            )
        ...
        if self.player.get("sleep", 0) < 30:
            if not self.player.get("insane", False):
                ...
                print(
                    Colors.colorize(
                        "You haven't been sleeping enough. You're starting to hallucinate...",
                        Colors.RED,
                    )
                )
                print(
                    Colors.colorize(
                        "50% chance of action failure until you get proper rest.",
                        Colors.RED,
                    )
                )
            ...
            if self.player.get("insane", False):
                ...
                print(
                    Colors.colorize(
                        "You feel clear-headed and alert again after a good rest.",
                        Colors.GREEN,
                    )
                )
    ...
    def cmd_rest(self, *args):
        ...
        if current_weather == "stormy":
            ...
            print(
                Colors.colorize(
                    "\nThe storm makes rest difficult, with thunder and lightning disturbing your sleep.",
                    weather_info["color"],
                )
            )
        elif current_weather == "rainy":
            ...
            danger_modifier = (
                0.9  # Rain masks sounds, making zombie encounters less likely
            )
            print(
                Colors.colorize(
                    "\nThe rain patters on the roof as you try to rest.",
                    weather_info["color"],
                )
            )
        elif current_weather == "foggy":
            ...
            print(
                Colors.colorize(
                    "\nThe thick fog creates an eerie atmosphere as you try to rest.",
                    weather_info["color"],
                )
            )
        elif current_weather == "hot":
            ...
            print(
                Colors.colorize(
                    "\nThe oppressive heat makes it difficult to sleep comfortably.",
                    weather_info["color"],
                )
            )
        elif current_weather == "cold":
            ...
            print(
                Colors.colorize(
                    "\nYou huddle for warmth as you try to rest in the cold.",
                    weather_info["color"],
                )
            )
        elif current_weather == "clear":
            ...
            print(
                Colors.colorize(
                    "\nThe peaceful clear weather provides ideal conditions for rest.",
                    weather_info["color"],
                )
            )
        elif current_weather == "windy":
            ...
            danger_modifier = (
                1.1  # Wind can mask zombie sounds, increasing surprise encounters
            )
            print(
                Colors.colorize(
                    "\nThe howling wind makes it harder to sleep soundly.",
                    weather_info["color"],
                )
            )
        ...
        if danger_level > 0 and random.random() < encounter_chance:
            ...
            print(
                Colors.colorize(
                    f"After {actual_hours} hours, your rest is interrupted by zombies!",
                    Colors.BOLD + Colors.RED,
                )
            )
            ...
            stamina_recovery = min(
                modified_recovery, self.player["max_stamina"] - self.player["stamina"]
            )
            self.player["stamina"] += stamina_recovery
            ...
            if new_days > self.player["days_survived"]:
                ...
                days = self.player["days_survived"]
                print(
                    Colors.colorize(f"You have survived for {days} days!", Colors.GREEN)
                )
            ...
            if rest_quality_modifier >= 1.1:
                print(
                    Colors.colorize(
                        f"You feel well-rested. Recovered {stamina_recovery} stamina.",
                        Colors.GREEN,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"Your rest was disturbed by the weather. Recovered {stamina_recovery} stamina.",
                        Colors.YELLOW,
                    )
                )
            else:
                print(
                    Colors.colorize(
                        f"You had a poor rest due to the harsh weather. Recovered only {stamina_recovery} stamina.",
                        Colors.RED,
                    )
                )
            ...
            if self.player["hunger"] > 30 and self.player["thirst"] > 30:
                ...
                if health_recovery > 0:
                    ...
                    print(
                        Colors.colorize(
                            f"Your wounds have healed. Recovered {health_recovery} health.",
                            Colors.GREEN,
                        )
                    )

                    # Chance to cure status effects in good weather
                    if current_weather == "clear" and self.player.get(
                        "hardcore_mode", False
                    ):
                        ...
                        if self.player.get("bleeding", False) and random.random() < 0.2:
                            ...
                            print(
                                Colors.colorize(
                                    "The restful conditions have helped stop your bleeding.",
                                    Colors.GREEN,
                                )
                            )
                        ...
                        if self.player.get("infected", False) and random.random() < 0.1:
                            ...
                            print(
                                Colors.colorize(
                                    "Your body has fought off the infection while resting.",
                                    Colors.GREEN,
                                )
                            )
    ...
    def cmd_go(self, *args):
        ...
        if not args or (len(args) >= 1 and args[0] == "help"):
            ...
            # Add safety for player location access
            current_location = self.player.get("location", "camp")
            ...
            if vehicles:
                ...
                for vehicle_id, vehicle_data in vehicles.items():
                    if not vehicle_data:
                        continue  # Skip if vehicle data is None or empty
                    ...
                    print(
                        f"- {vehicle_id} ({vehicle_name}) - Speed: {vehicle_data.get('speed', 1)}x{fuel_status}"
                    )
            return
        ...
        # Safety checks for destination using defensive coding
        if not isinstance(LOCATIONS, dict) or destination not in LOCATIONS:
            print(f"Unknown location: {destination}")
            print("Type '/go help' to see available locations.")
            return
        ...
        player_stamina = self.player.get("stamina", 0)
        if not vehicle_id and player_stamina < 10:
            print(
                "You're too exhausted to travel on foot. Rest, use items to restore stamina, or use a vehicle."
            )
            return
            ...
            if vehicle_data.get("fuel_type"):
                ...
                if current_fuel < fuel_consumption:
                    ...
                    fuel_type = (
                        ...
                        else vehicle_data.get("fuel_type", "fuel")
                    )
                    vehicle_name = (
                        "vehicle"
                        if vehicle_data is None
                        else vehicle_data.get("name", "vehicle")
                    )
                    print(
                        f"Not enough {fuel_type} in your {vehicle_name} for this journey."
                    )
                    return
        ...
        # Use our helper function for safer access
        destination_data = get_safe_location(destination, "camp")
        danger_level = destination_data.get(
            "danger_level", 5
        )  # Default to high danger if not specified
        ...
        if danger_level > 0 and random.random() < encounter_chance:
            ...
            if vehicle_protection > 0 and vehicle_data:
                print(
                    f"Your {vehicle_data.get('name', 'vehicle')} provides some protection."
                )
            ...
            # Update location with extended safety checks
            if isinstance(self.player, dict):
                self.player["location"] = destination
                # Check mission progress for travel
                self.check_mission_progress("location", destination)
            else:
                print(
                    "Error: Unable to update player location. Player data is invalid."
                )
                return

            # Safely access location name with a default value
            location_name = destination_data.get(
                "name", f"Unknown Area ({destination})"
            )
            print(f"\nYou have traveled to {location_name}.")

            # Consume resources based on travel method
            if vehicle_id:
                # Consume fuel
                if fuel_consumption > 0:
                    # Get vehicles reference again with safety checks
                    vehicles = self.get_player_vehicles() or {}

                    # Safe vehicle access
                    if vehicle_id in vehicles:
                        vehicle = vehicles[vehicle_id]
                        current_fuel = vehicle.get("current_fuel", 0)

                        # Update fuel with safety check
                        new_fuel = max(0, current_fuel - fuel_consumption)
                        vehicles[vehicle_id]["current_fuel"] = new_fuel

                        # Use default fuel type if needed
                        fuel_type = (
                            "fuel"
                            if vehicle_data is None
                            else vehicle_data.get("fuel_type", "fuel")
                        ...
                        print(
                            f"Consumed {fuel_consumption} units of {fuel_type}. Remaining: {new_fuel}"
                        )
                    else:
                        print("Warning: Vehicle data not found. Fuel not consumed bro.")

                # Small stamina cost for driving with safe access
                current_stamina = self.player.get("stamina", 0)
                self.player["stamina"] = max(current_stamina - 3, 0)
            else:
                # Higher stamina cost for walking with safe access
                current_stamina = self.player.get("stamina", 0)
                self.player["stamina"] = max(current_stamina - 10, 0)
    ...
    def cmd_vehicles(self, *args):
        ...
        if command == "list":
            ...
            for vehicle_id, vehicle_data in vehicles.items():
                ...
                print(
                    f"  Condition: {vehicle_data.get('durability', 0)}/{vehicle_data.get('max_durability', 100)}"
                )
                ...
                if vehicle_data.get("fuel_type"):
                    ...
                    max_fuel = vehicle_data.get("fuel_capacity", 0)
                    print(
                        f"  Fuel ({vehicle_data['fuel_type']}): {current_fuel}/{max_fuel}"
                    )
            ...
            if not repair_reqs:
                print("You don't know how to repair this vehicle.")
                return
            ...
            if not can_repair:
                print(
                    f"You need the following items to repair your {vehicle_data['name']}:"
                )
            ...
            vehicles[vehicle_id]["durability"] = min(
                durability + repair_amount, max_durability
            )

            print(
                f"You've repaired your {vehicle_data['name']}. New condition: {vehicles[vehicle_id]['durability']}/{max_durability}"
            )
            ...
            if not fuel_type:
                print("This vehicle doesn't require fuel bro.")
                return
            ...
            print(
                f"You've added {fuel_to_use} units of {fuel_type} to your {vehicle_data['name']}."
            )
            ...
            print(f"Protection: {vehicle_data.get('armor', 0)}")
            print(
                f"Description: {vehicle_data.get('description', 'No description available.')}"
            )
    ...
    def cmd_craft_vehicle(self, *args):
        ...
        if not vehicle_data.get("craftable", False):
            print(
                f"You cannot craft a {vehicle_data['name']}. You must find one instead."
            )
            return
        ...
        if difficulty == "extreme" and player_level < 10:
            print(
                f"Crafting a {vehicle_data['name']} requires level 10 mechanics skill. Your level: {player_level}"
            )
            return
        elif difficulty == "hard" and player_level < 5:
            print(
                f"Crafting a {vehicle_data['name']} requires level 5 mechanics skill. Your level: {player_level}"
            )
            return
        ...
        if not crafting_reqs:
            print("You don't know how to craft this vehicle LOL.")
            return
    ...
    def cmd_explore(self, *args):
        ...
        if self.player["stamina"] < 15:
            print(
                "You're too exhausted to explore. Rest or use items to restore stamina."
            )
            return
        ...
        if random.random() < chance:
            ...
            matching_items = [
                ...
                or (resource_type == "weapons" and item["type"] == "weapon")
                or (resource_type == "medical" and item["type"] == "medical")
            ]

            if matching_items:
                # For Research Station, add a chance to find experimental weapons
                if (
                    self.player["location"] == "research_station"
                    and resource_type == "weapons"
                    ...
                    existing_experimental = [
                        item_id
                        for item_id in experimental_items
                        if self.find_item_index(item_id) >= 0
                    ]

                    # Prefer weapons player doesn't already have
                    available_weapons = [
                        w for w in experimental_items if w not in existing_experimental
                    ]
                    ...
                    print(
                        Colors.colorize(
                            "\nYou've discovered a sealed research cabinet in a secured lab area!",
                            Colors.CYAN,
                        )
                    )
                    time.sleep(1)
                    print(
                        Colors.colorize(
                            "After bypassing the security measures, you find an experimental prototype weapon...",
                            Colors.CYAN,
                        )
                    )
                    time.sleep(1)
                ...
                if self.add_to_inventory(found_item_id):
                    print(
                        f"You found: {Colors.colorize(found_item['name'], Colors.GREEN)}!"
                    )
                    ...
                    if found_item_id in EXPERIMENTAL_WEAPONS:
                        print(
                            Colors.colorize(
                                "\nThis is a rare prototype weapon with unique combat capabilities!",
                                Colors.YELLOW,
                            )
                        )
                        print(
                            Colors.colorize(
                                "Handle with care - it may be the only one of its kind remaining.",
                                Colors.YELLOW,
                            )
                        )
                    ...
                    print(
                        f"You found {found_item['name']}, but your inventory is full!"
                    )
            else:
        ...
        base_encounter_chance = location.get(
        ...
        if random.random() < encounter_chance:
            ...
            if location.get("infected_animals", False):
                ...
                encounter_type = random.choices(
                    ["zombie", "animal", "survivor"], weights=[0.4, 0.5, 0.1], k=1
                )[0]
            ...
            if location.get("survivor_encounter_chance", 0):
                ...
                if survivor_chance > 0:
                    encounter_type = random.choices(
                        ["zombie", "animal", "survivor"],
                        weights=[
                            max(0.1, 0.7 - (survivor_chance * 0.5)),
                            0.3,
                            survivor_chance,
                        ],
                        k=1,
            ...
            if encounter_type == "zombie":
                ...
                self.current_enemy = (
                    self.current_zombie
                )  # Set both references for consistency
                self.start_combat()
        ...
        if (
            not encounter_happened
            and "special_areas" in location
            and "special_items" in location
        ):
            special_item_chance = location.get(
            ...
            if random.random() < special_item_chance:
                ...
                if self.add_to_inventory(special_item_id):
                    ...
                    print(
                        f"You found a {ITEMS[special_item_id]['name']}, but your inventory is full!"
                    )
    ...
    def start_combat(self):
        ...
        if enemy_type == "animal":
            print(
                Colors.colorize(
                    f"COMBAT: {enemy['name']} attacks!", Colors.BOLD + combat_color
                )
            )
            ...
            print(
                Colors.colorize(
                    f"COMBAT: {enemy['name']} appears!", Colors.BOLD + combat_color
                )
            )
        ...
        player_health_color = Colors.health_color(
            self.player["health"], self.player["max_health"]
        )
        ...
        if enemy_type == "animal":
            print(
                f"Animal Health: {Colors.colorize(f'{enemy_health}/{enemy_max_health}', enemy_health_color)}"
            )
        elif enemy_type == "survivor":
            print(
                f"Survivor Health: {Colors.colorize(f'{enemy_health}/{enemy_max_health}', enemy_health_color)}"
            )
        else:
            print(
                f"Zombie Health: {Colors.colorize(f'{enemy_health}/{enemy_max_health}', enemy_health_color)}"
            )

        print(
            f"Your Health: {Colors.colorize(f'{player_health}/{player_max_health}', player_health_color)}"
        )
        ...
        if enemy_type == "zombie":
            if is_night:
                print(
                    Colors.colorize(
                        "\nNight Combat: Zombies deal more damage and are harder to hit!",
                        Colors.BOLD + Colors.BLUE,
                    )
                )
                if damage_boost > 0:
                    print(
                        Colors.colorize(
                            f"The darkness gives the zombie +{damage_boost} attack damage!",
                            Colors.RED,
                        )
                    )
            elif is_dawn_dusk:
                print(
                    Colors.colorize(
                        "\nDusk/Dawn Combat: Limited visibility affects combat.",
                        Colors.MAGENTA,
                    )
                )
        ...
        if enemy_type == "animal":
            if "pack_hunter" in enemy and enemy.get("pack_attack", False):
                print(
                    Colors.colorize(
                        f"\nThe {enemy['name']} is hunting in a pack! They coordinate their attacks.",
            ...
            if "ambush" in enemy and enemy.get("ambush", False):
                print(
                    Colors.colorize(
                        f"\nThe {enemy['name']} is an ambush predator! Watch for surprise attacks.",
                        Colors.BOLD + Colors.GREEN,
                    )
                )
        elif enemy_type == "survivor":
            if "skills" in enemy and enemy["skills"]:
                ...
                print(
                    Colors.colorize(
                        f"\nThis survivor has skills in: {skill_list}",
        ...
        if current_weather in WEATHER_TYPES and current_weather != "clear":
            ...
            if current_weather == "rainy":
                print(
                    Colors.colorize(
                        "\nRain Effect: Zombies move slower but visibility is reduced.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "foggy":
                print(
                    Colors.colorize(
                        "\nFog Effect: Severely reduced visibility - increased miss chance!",
                        weather_info["color"],
                    )
                )
                ...
                print(
                    Colors.colorize(
                        "\nStorm Effect: Zombies are slower but visibility is poor.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "windy":
                print(
                    Colors.colorize(
                        "\nWind Effect: Ranged weapons less accurate.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "hot":
    ...
    def get_companions_assistance(self, enemy_type):
        ...
        companion_specializations = self.player.get(
            "companion_weapon_specializations", {}
        )
        for idx, companion in enumerate(self.player.get("companions", [])):
            ...
            if random.random() < assist_chance:
                ...
                if (
                    "marksmanship" in companion.get("skills", [])
                    and current_weapon_type == "ranged"
                ):
                    assist_multiplier += 0.25

                if (
                    "blade_master" in companion.get("skills", [])
                    and current_weapon_type == "blade"
                ):
                    assist_multiplier += 0.25

                if (
                    "explosives" in companion.get("skills", [])
                    and current_weapon_type == "explosive"
                ):
                ...
                messages.append(
                    Colors.colorize(random.choice(assist_messages), Colors.CYAN)
                )
                ...
                if random.random() < injury_chance:
                    ...
                    companion["recovery_time"] = random.randint(
                        2, 6
                    )  # Hours needed to recover
                    messages.append(
                        Colors.colorize(
                            f"{companion['name']} was injured while helping you fight!",
                            Colors.RED,
                        )
                    )
    ...
    def process_status_effects(self, enemy):
        ...
        Args:
            enemy (dict): The enemy with potential status effects

        Returns:
            tuple: (damage_multiplier, speed_multiplier, status_message)
        """
        damage_multiplier = 1.0
        speed_multiplier = 1.0
        status_message = ""

        # Safety check for None value
        if enemy is None:
            return damage_multiplier, speed_multiplier, status_message

        # Make sure enemy is a dictionary and has a name
        enemy_name = enemy.get("name", "enemy") if isinstance(enemy, dict) else "enemy"

        # Make sure status_effects is initialized
        if not isinstance(enemy, dict) or "status_effects" not in enemy:
            # If enemy doesn't have a status_effects dict, nothing to process
            return damage_multiplier, speed_multiplier, status_message

        # Get status effects dictionary (safely)
        status_effects = enemy.get("status_effects", {})
        if not isinstance(status_effects, dict):
            # If status_effects exists but isn't a dictionary, reset it
            enemy["status_effects"] = {}
            return damage_multiplier, speed_multiplier, status_message

        # Process stun effect (from Sonic Disruptor)
        if "stunned" in status_effects:
            turns_left = status_effects.get("stunned", 0)
            if turns_left > 0:
                damage_multiplier *= 0.5  # Stunned enemies deal 50% damage
                speed_multiplier *= 0.3  # Stunned enemies are 70% slower
                status_message = Colors.colorize(
                    f"The {enemy_name} is stunned and struggles to attack effectively.",
                    Colors.CYAN,
                )
                # Reduce stun duration
                status_effects["stunned"] -= 1
                if status_effects["stunned"] <= 0:
                    del status_effects["stunned"]
                    print(
                        Colors.colorize(
                            f"The {enemy_name} recovers from being stunned.",
                            Colors.YELLOW,
                        )
                    )

        # Process freeze effect (from Cryo Rifle)
        if "frozen" in status_effects:
            turns_left = status_effects.get("frozen", 0)
            if turns_left > 0:
                speed_multiplier *= 0.4  # Frozen enemies are 60% slower
                status_message = Colors.colorize(
                    f"The {enemy_name} is partially frozen and moves sluggishly.",
                    Colors.BLUE,
                )
                # Reduce freeze duration
                status_effects["frozen"] -= 1
                if status_effects["frozen"] <= 0:
                    del status_effects["frozen"]
                    print(
                        Colors.colorize(
                            f"The ice crystals on the {enemy_name} have melted.",
                            Colors.YELLOW,
                        )
                    )

        # Process acid effect (from Chemical Thrower)
        if "acid" in status_effects:
            acid_data = status_effects.get("acid", {})
            if isinstance(acid_data, dict) and acid_data.get("turns", 0) > 0:
                # Apply damage over time
                if "health" in enemy:
                    enemy["health"] -= acid_data.get("damage", 0)
                status_message = Colors.colorize(
                    f"The corrosive chemicals eat away at the {enemy_name}, dealing {acid_data.get('damage', 0)} damage.",
                    Colors.GREEN,
                )
                # Reduce acid duration
                acid_data["turns"] -= 1
                if acid_data.get("turns", 0) <= 0:
                    del status_effects["acid"]
                    print(
                        Colors.colorize(
                            f"The chemical effect on the {enemy_name} dissipates.",
                            Colors.YELLOW,
                        )
                    )

        # Process burning effect (from Flamethrower, Molotov, etc.)
        if "burning" in status_effects:
            burn_data = status_effects.get("burning", {})
            if isinstance(burn_data, dict) and burn_data.get("turns", 0) > 0:
                # Apply fire damage over time
                if "health" in enemy:
                    enemy["health"] -= burn_data.get("damage", 0)
                status_message = Colors.colorize(
                    f"The flames engulf the {enemy_name}, dealing {burn_data.get('damage', 0)} fire damage.",
                    Colors.RED,
                )
                # Reduce burning duration
                burn_data["turns"] -= 1
                if burn_data.get("turns", 0) <= 0:
                    del status_effects["burning"]
                    print(
                        Colors.colorize(
                            f"The fire consuming the {enemy_name} burns out.",
                            Colors.YELLOW,
                        )
                    )
    ...
    def _get_current_enemy(self):
        ...
        elif hasattr(self, "current_enemy"):
    ...
    def _check_weapon_durability(self, weapon):
        ...
        if weapon is not None and isinstance(weapon, dict):
            ...
            if (
                ...
                and weapon.get("durability") is not None
                and weapon.get("durability", 0) <= 0
            ):
                weapon_name = weapon.get("name", "weapon")
                print(
                    Colors.colorize(
                        f"Your {weapon_name} breaks from extensive use!", Colors.RED
                    )
                )
                if (
                    self.player
                    and isinstance(self.player, dict)
                    and "equipped_weapon" in self.player
                    and self.player["equipped_weapon"] is not None
                ):
    ...
    def _apply_stamina_effects(self, hardcore_mode, stamina_percent, damage):
        ...
        if hardcore_mode and stamina_percent < 0.3:
            ...
            if self.player and isinstance(self.player, dict):
                stamina_cost = 2
                current_stamina = self.player.get("stamina", 0)
                self.player["stamina"] = max(0, current_stamina - stamina_cost)
    ...
    def _apply_mental_stress_effects(self, hardcore_mode):
        ...
        if self.player.get("insanity", 0) > 50:
            ...
            print(
                Colors.colorize(
                    "Your mental state is affecting your combat performance...",
                    Colors.MAGENTA,
                )
            )
            ...
            if random.random() < 0.1:
                hallucinations = [
                    ...
                    "You feel something crawling under your skin — is it the infection?",
                    "That dead body you passed earlier... you swear it just moved.",
                    "You reload your gun, but when you blink, it's missing again...",
                    "You keep hearing the gnashing of teeth — even in total silence...",
                    "You look at your hands and see them rotting...",
                    "You think you see a horde in the distance — it vanishes when you focus...",
                    "You swear a zombie just whispered your name...",
                    "A survivor turns to face you — their eyes are pure white...",
                    "You stab a zombie, but it doesn't react. Then it vanishes.",
                    "You feel a bite — but there's no one there...",
                    "You cough and taste blood... was it yours, or someone else's?",
                    "You see a friendly survivor... until they melt into a corpse.",
                    "Every groan starts to sound like pleading cries for help...",
                    "You keep hearing radio static... but your radio's been broken for days.",
                    "The blood on the ground forms words... 'Join us.'",
                ]
                print(
                    Colors.colorize(
                        f"\n  {random.choice(hallucinations)}", Colors.MAGENTA
    ...
    def _handle_chain_lightning_effect(self, weapon, enemy_name):
        ...
        for i in range(chain_targets):
            if i < len(self.nearby_enemies):
                ...
                if isinstance(target, dict) and "health" in target:
                    target["health"] -= chain_damage
                    target_name = target.get("name", "nearby enemy")
                    print(Colors.colorize(
    ...
    def _handle_area_effect_weapon(self, weapon, weapon_id, enemy, enemy_type, damage, weakness_bonus):
        ...
        Args:
            ...
            weakness_bonus (float): Damage multiplier from enemy weaknesses
        """
        ...
        if weapon_id == "flamethrower":
            ...
            if enemy_type == "zombie":
                print(Colors.colorize(f"You throw the {weapon_name} at the zombies!", Colors.YELLOW))
        ...
        print(f"The {enemy_name} takes {Colors.colorize(str(actual_damage), Colors.RED)} damage from the flames!")
        ...
        if enemy_type == "zombie":
            ...
            if random.random() < 0.5:
                ...
                enemy["dodge_penalty"] = 15  # Makes it harder for them to dodge next turn

        # Flamethrower uses fuel
        if weapon_id == "flamethrower" and weapon and isinstance(weapon, dict) and "ammo" in weapon:
        ...
        if weapon_id == "molotov" and isinstance(self.player, dict):
            self.remove_from_inventory(self.player.get("equipped_weapon"))
            self.player["equipped_weapon"] = None
        else:
            # Reduce durability for other weapons
            if weapon and isinstance(weapon, dict) and "durability" in weapon:
    ...
    def _calculate_weakness_bonus(self, enemy_type, enemy, weapon):
        ...
        if enemy_type == "zombie":
            # Zombie weaknesses based on type
    ...
    def _handle_special_effect_weapon(self, weapon, enemy, enemy_type):
        ...
        if special_effect == "emp" and enemy_type == "survivor":
            ...
            if random.random() < 0.7:
                print(Colors.colorize(
                    f"Your {weapon_name} releases an electromagnetic pulse, disrupting {enemy_name}'s electronic equipment!",
                    Colors.BLUE
                ))
                ...
                if "status_effects" not in enemy:
                    enemy["status_effects"] = {}
                enemy["status_effects"]["emp_disabled"] = 2
                
                # Reduce enemy hit chance
                enemy["hit_penalty"] = enemy.get("hit_penalty", 0) + 25
                return True
                
        elif special_effect == "tranquilizer" and enemy_type == "animal":
            # Tranquilizer can instantly incapacitate animals
            if random.random() < 0.4:
                print(Colors.colorize(
                    f"Your {weapon_name} successfully tranquilizes the {enemy_name}!",
                    Colors.GREEN
                ))
                self.end_combat(True)  # Peaceful resolution to combat
                return True
                
        elif special_effect == "phase" and enemy_type == "zombie":
            # Phase weapons have chance to bypass zombie defenses
            if random.random() < 0.3:
                print(Colors.colorize(
                    f"Your {weapon_name} phases through the {enemy_name}'s body, causing massive internal damage!",
                    Colors.MAGENTA
                ))
                damage = weapon.get("damage", 10) * 2
                enemy["health"] -= damage
                print(f"Critical phase damage: {Colors.colorize(str(damage), Colors.RED)}")
    ...
    def cmd_attack(self, *args):
        ...
        # Player attacks first - get enemy safely using helper method
        enemy = self._get_current_enemy()
        
        # Determine hardcore mode safely
        hardcore_mode = (
            self.player.get("hardcore_mode", False)
            if isinstance(self.player, dict)
            else False
        )

        # Determine enemy type with null safety using helper method
        enemy_type = self._determine_enemy_type(enemy)

        # Get companion assistance for combat
        companion_damage_bonus, companion_messages = self.get_companions_assistance(
            enemy_type
        )
        ...
        if self.player and isinstance(self.player, dict):
            stamina_percent = self.player.get("stamina", 0) / max(1, self.player.get("max_stamina", 1))
        else:
            stamina_percent = 1.0
        ...
        # Initialize status effects for enemy with null safety using helper method
        self._initialize_enemy_status_effects(enemy)

        # Check weapon durability with proper null safety using helper method
        if self._check_weapon_durability(weapon):
            return  # Weapon is broken, exit attack function

        # Apply stamina effects using the helper method
        stamina_penalty, damage_reduction = self._apply_stamina_effects(hardcore_mode, stamina_percent, damage)
        if damage_reduction > 0:
            damage = int(damage * (1 - damage_reduction))
            
        # Apply mental stress effects using the helper method
        insanity_penalty = self._apply_mental_stress_effects(hardcore_mode)
        
        # Calculate weakness bonus based on enemy type and weapon
        weakness_bonus = 1.0
        if isinstance(enemy, dict) and isinstance(weapon, dict):
            weakness_bonus = self._calculate_weakness_bonus(enemy_type, enemy, weapon)
    ...
    def _execute_normal_attack(
        ...
        Args:
            ...
            damage (int): Base damage amount
            weakness_bonus (float): Damage multiplier from enemy weaknesses
            stamina_penalty (float): Hit chance penalty from stamina
            insanity_penalty (float): Hit chance penalty from mental stress
            companion_damage_bonus (int): Bonus damage from companions
            hardcore_mode (bool): Whether hardcore mode is enabled
            stamina_percent (float): Current stamina percentage
        """
        if not enemy or not isinstance(enemy, dict):
        ...
        if weapon and isinstance(weapon, dict):
            ...
            special_effect = weapon.get("special_effect")
            if special_effect == "stun" and random.random() < weapon.get("stun_chance", 0.5):
                if "status_effects" not in enemy:
                    enemy["status_effects"] = {}
            ...
            # Pulse Gauntlet chain lightning effect (with null safety)
                ...
                # Use the helper method for chain lightning
                self._handle_chain_lightning_effect(weapon, enemy_name)
                
            # Chemical Thrower acid effect (with complete null safety)
            elif special_effect == "acid" and enemy is not None and isinstance(enemy, dict):
                # Use helper method for acid effect
                self._handle_acid_effect(weapon, enemy, enemy_name, weapon_name)

            # Different handling based on enemy type
            weakness_bonus = 1.0

            # Safe check that enemy is a valid dictionary
            if isinstance(enemy, dict) and enemy is not None:
                if enemy_type == "zombie":
                    # Check zombie type for weaknesses
                    enemy_subtype = enemy.get("type", "walker")
                    zombie_weakness = ZOMBIE_TYPES.get(enemy_subtype, {}).get(
                        "weakness", None
                    )

                    # Apply bonus damage if the weapon exploits zombie weakness and weapon is a valid dictionary
                    if (
                        zombie_weakness
                        and isinstance(weapon, dict)
                        and weapon.get("damage_type", None) == zombie_weakness
                    ):
                    ...
                    # Some weapons are better against certain animals - check weapon is valid dict
                    if isinstance(weapon, dict):
                        weapon_name = weapon.get("name", "weapon")
                        weapon_damage_type = weapon.get("damage_type")

                        if (
                            animal_type in ["bear", "boar"]
                            and weapon_damage_type == "piercing"
                        ):
                            weakness_bonus = (
                                1.5  # Piercing weapons better against large animals
                            )
                            print(
                                Colors.colorize(
                                    f"Your {weapon_name} cuts deep into the {animal_type}!",
                                    Colors.GREEN,
                                )
                            )
                        elif (
                ...
                if (
                    ...
                    if weapon_damage_type == "piercing":
                        weakness_bonus = (
                            1.3  # Piercing weapons better against armored survivors
                        )
                        print(
                            Colors.colorize(
                                f"Your {weapon_name} finds a weak spot in their armor!",
                                Colors.GREEN,
                            )
                        )
                    elif weapon_damage_type == "blunt":
                        weakness_bonus = (
                            0.8  # Blunt weapons less effective against armor
                        )
                        print(
                            Colors.colorize(
                                f"Their armor absorbs some of the impact from your {weapon_name}!",
                                Colors.YELLOW,
                            )
                        )

            # Check for experimental weapons with null safety
            is_experimental = False
            # Initialize variables to avoid unbound errors
            weapon_id = self.player.get("equipped_weapon", "fists")
            special_effect = None

            if weapon_id is not None and "EXPERIMENTAL_WEAPONS" in globals():
                if weapon_id in EXPERIMENTAL_WEAPONS:
                    is_experimental = True
                    special_effect = EXPERIMENTAL_WEAPONS[weapon_id].get(
                        "special_effect", None
                    )

                # Apply experimental weapon special effects using the new status_effects system
                if (
                    special_effect == "stun"
                    and enemy is not None
                    and weapon_id in EXPERIMENTAL_WEAPONS
                    and random.random()
                    < EXPERIMENTAL_WEAPONS[weapon_id].get("stun_chance", 0.5)
                ):
                    # Safe access to weapon and enemy properties
                    weapon_name = weapon.get("name", "weapon") if weapon else "weapon"
                    enemy_name = (
                    ...
                    if (
                        "EXPERIMENTAL_WEAPONS" in globals()
                        and "weapon_id" in locals()
                        and weapon_id is not None
                    ):
                        chain_targets = EXPERIMENTAL_WEAPONS.get(weapon_id, {}).get(
                            "chain_targets", 1
                        )
                    else:
                        chain_targets = 1

                    if chain_targets > 1 and "damage" in locals():
                        # Calculate chain damage safely (with fallback to weapon base damage)
                        base_damage = (
                            damage if "damage" in locals() else weapon.get("damage", 10)
                        )
                        chain_damage = int(
                            base_damage * 0.6
                        )  # Chain damage is 60% of primary
                    ...
                    if (
                        ...
                        dot_damage = EXPERIMENTAL_WEAPONS.get(weapon_id, {}).get(
                            "dot_damage", 5
                        )
                        dot_duration = EXPERIMENTAL_WEAPONS.get(weapon_id, {}).get(
                            "dot_duration", 3
                        )
                    else:
                        # Default values if cannot access EXPERIMENTAL_WEAPONS
                        dot_damage = 5
                        dot_duration = 3

                    # Safe access to weapon and enemy names
                    weapon_name = (
                        weapon.get("name", "weapon")
                        if isinstance(weapon, dict)
                        else "weapon"
                    )
                    enemy_name = enemy.get("name", "enemy")
                    ...
                    print(
                        Colors.colorize(
                            f"The {weapon_name} sprays corrosive compounds that stick to {enemy_name}!",
                            Colors.CYAN,
                        )
                    )
                    ...
                    print(
                        Colors.colorize(
                            f"Acid begins eating through {enemy_name}'s defenses, causing ongoing damage!",
                            Colors.GREEN,
                        )
                    )

            # Check for special weapon properties with proper null safety
            # Handle area effect weapons (Molotov, Flamethrower)
            elif weapon_id == "molotov" or (
                weapon is not None
                and isinstance(weapon, dict)
                and weapon.get("area_effect", False)
            ):
                weapon_name = "weapon"
                if weapon is not None and isinstance(weapon, dict):
                    weapon_name = weapon.get("name", "weapon")
                ...
                if weapon_id == "flamethrower":
                    print(
                        Colors.colorize(
                            f"You unleash a stream of fire from your {weapon_name}!",
                            Colors.YELLOW,
                        )
                    )
                else:
                    if enemy_type == "zombie":
                        print(
                            Colors.colorize(
                                f"You throw the {weapon_name} at the zombies!",
                                Colors.YELLOW,
                            )
                        )
                    elif (
                        ...
                        enemy_name = enemy.get("name", "animal")
                        print(
                            Colors.colorize(
                                f"You throw the {weapon_name} at the {enemy_name}!",
                                Colors.YELLOW,
                            )
                        )
                    else:
                        print(
                            Colors.colorize(
                                f"You throw the {weapon_name} at the survivor!",
                                Colors.YELLOW,
                            )
                        )
                ...
                if enemy is not None and isinstance(enemy, dict):
                    ...
                    enemy["health"] = enemy_health - actual_damage
                    enemy_name = enemy.get("name", "enemy")
                    print(
                        f"The {enemy_name} takes {Colors.colorize(str(actual_damage), Colors.RED)} damage from the flames!"
                    )

                # Different effects based on enemy type with enhanced null safety
                if (
                    enemy_type == "zombie"
                    and enemy is not None
                    and isinstance(enemy, dict)
                    ...
                    if enemy_subtype == "bloater" and random.random() < 0.6:
                        print(
                            Colors.colorize(
                                "The bloater's gas ignites in a violent explosion!",
                                Colors.RED,
                            )
                        )
                        explosion_damage = damage * 2
                        enemy_health = enemy.get("health", 0)
                        enemy["health"] = enemy_health - explosion_damage
                        print(
                            f"The bloater takes an additional {Colors.colorize(str(explosion_damage), Colors.RED)} damage!"
                        )
                    ...
                    if random.random() < 0.5:
                        ...
                        print(
                            Colors.colorize(
                                "The fire spreads, damaging nearby zombies!",
                                Colors.YELLOW,
                            )
                        )
                        print(
                            f"All zombies in the area take an additional {Colors.colorize(str(extra_damage), Colors.RED)} damage."
                        )
                        enemy_health = enemy.get("health", 0)
                        enemy["health"] = enemy_health - extra_damage
                    ...
                    # Animals may panic when on fire - with null safety
                    if random.random() < 0.7:
                        enemy_name = enemy.get("name", "animal")
                        print(
                            Colors.colorize(
                                f"The {enemy_name} panics in the flames!", Colors.YELLOW
                            )
                        )
                        enemy["skip_turn"] = True
                    ...
                    # Survivors might try to put the fire out - with null safety
                    if random.random() < 0.5:
                        enemy_name = enemy.get("name", "survivor")
                        print(
                            Colors.colorize(
                                f"The {enemy_name} tries to extinguish the flames!",
                                Colors.YELLOW,
                            )
                        )
                        dodge_penalty = (
                            15  # Makes it harder for them to dodge next turn
                        )

                # Flamethrower uses fuel - with proper null safety
                if (
                    ...
                    # Safely decrease ammo and handle max_ammo with default
                    current_ammo = weapon.get("ammo", 0)
                    max_ammo = weapon.get(
                        "max_ammo", 10
                    )  # Default max if not specified
                    weapon["ammo"] = max(0, current_ammo - 1)
                    print(
                        Colors.colorize(
                            f"Fuel remaining: {weapon['ammo']}/{max_ammo}",
                            Colors.YELLOW,
                        )
                    )
                    ...
                    if weapon["ammo"] <= 0:
                        print(
                            Colors.colorize(
                                "Your flamethrower is out of fuel!", Colors.RED
                            )
                        )
                ...
                if (
                    ...
                    # Reduce durability for other weapons with proper null safety
                    if (
                        weapon is not None
                        and isinstance(weapon, dict)
                        and "durability" in weapon
                    ):
                        current_durability = weapon.get("durability", 0)
                        weapon["durability"] = max(0, current_durability - 1)

                # Skip the normal attack flow with null safety
                if (
                    enemy is not None
                    and isinstance(enemy, dict)
                    and enemy.get("health", 0) <= 0
                ):
                    self.end_combat(True)
                    return
            ...
            # Handle flamethrower separately (it's an area weapon but reusable)
                ...
                if weapon is not None and weapon["ammo"] <= 0:
                    print(
                        Colors.colorize(
                            f"Your {weapon['name']} is out of fuel!", Colors.RED
                        )
                    )
                    print(
                        Colors.colorize(
                            "You'll need to find fuel canisters to use it again.",
                            Colors.YELLOW,
                        )
                    )
                else:
                    weapon_name = weapon['name'] if weapon and isinstance(weapon, dict) else "weapon"
                    print(
                        Colors.colorize(
                            f"You unleash a stream of fire from your {weapon_name}!",
                            Colors.RED,
                    ...
                    if enemy_type == "bloater":
                        ...
                        print(
                            Colors.colorize(
                                f"BONUS EXPLOSION DAMAGE: {explosion_damage}!",
                                Colors.RED + Colors.BOLD,
                            )
                        )
                    elif enemy_type == "crawler":
                        crawler_bonus = (weapon or {}).get("crawler_bonus", 1.5)
                        print(
                            Colors.colorize(
                                "The crawler is completely engulfed in flames!",
                                Colors.YELLOW,
                            )
                        )
                        total_damage = int(total_damage * crawler_bonus)
                    elif enemy_type == "screamer" and (weapon or {}).get(
                        "screamer_panic", False
                    ):
                        print(
                            Colors.colorize(
                                "The screamer panics at the sight of the flames!",
                                Colors.GREEN,
                            )
                        )
                        ...
                        if random.random() < 0.5:
                            ...
                            if enemy is not None:
                                ...
                                print("Error: enemy is None!")
                            print(
                                Colors.colorize(
                                    "The screamer is too terrified to attack this turn!",
                                    Colors.GREEN,
                                )
                            )
                    ...
                    enemy = enemy or {}
                    enemy["health"] = enemy.get("health", 0) - total_damage
                    enemy_name = enemy.get("name", "enemy")
                    print(
                        f"The {enemy_name} takes {Colors.colorize(str(total_damage), Colors.RED)} damage from the intense flames!"
                    )

                    # Apply burn effect to the enemy using the new status_effects system - with null safety
                    if enemy is not None and isinstance(enemy, dict):
                        ...
                        # Get these values from weapon if it exists and has these attributes
                        if weapon is not None and isinstance(weapon, dict):
                            continuous_damage = weapon.get("continuous_damage", 5)
                            continuous_turns = weapon.get("continuous_turns", 2)

                        # Safely apply the effect
                        if "status_effects" in enemy:
                            enemy["status_effects"]["burning"] = {
                                "damage": continuous_damage,  # Standardized key name for damage
                                "turns": continuous_turns,  # Standardized key name for duration
                                "description": "On fire! Taking damage each turn.",
                            }

                        # Get enemy name safely for display
                        enemy_name = "enemy"
                        if "name" in enemy:
                            enemy_name = enemy.get("name", "enemy")
                        ...
                        print(
                            Colors.colorize(
                                f"The {enemy_name} is now on fire and will take {continuous_damage} damage for {continuous_turns} more turns!",
                                Colors.YELLOW,
                            )
                        )

                    # Chance to damage nearby enemies
                    area_damage_percent = weapon.get("area_damage_percent", 0.7) if weapon else 0.7
                    area_damage = int(total_damage * area_damage_percent)
                    print(
                        Colors.colorize(
                            "The fire spreads, damaging nearby hostiles!", Colors.YELLOW
                        )
                    )
                    print(
                        f"All enemies in the area take an additional {Colors.colorize(str(area_damage), Colors.RED)} damage."
                    )
                    enemy[
                        "health"
                    ] -= area_damage  # This simulates other enemies in the area also taking damage

                    # Create a temporary barrier of flames if the weapon has horde control
                    if weapon and weapon.get("horde_control", False):
                        print(
                            Colors.colorize(
                                "A wall of flames temporarily blocks the path, controlling the enemy horde!",
                                Colors.YELLOW,
                            )
                        )
                    ...
                    if weapon is not None:
                        ...
                        max_ammo = weapon.get("max_ammo", 0)
                        print(
                            Colors.colorize(
                                f"Fuel remaining: {weapon['ammo']}/{max_ammo}",
                                Colors.CYAN,
                    ...
                    attraction_radius = (weapon or {}).get("attraction_radius", 3)
                    attraction_chance = min(
                        0.1 * attraction_radius, 0.7
                    )  # Up to 70% chance based on radius

                    if random.random() < attraction_chance:
                        print(
                            Colors.colorize(
                                f"\nThe noise and flames have attracted more hostiles from up to {attraction_radius} zones away!",
                                Colors.RED,
                            )
                        )
            ...
            # Handle sonic disruptor (especially effective against screamers)
                ...
                # Check if it has ammo
                if weapon is not None and weapon.get("ammo", 0) <= 0:
                    print(
                        Colors.colorize(
                            f"Your {weapon.get('name', 'weapon')} is not loaded!",
                            Colors.RED,
                        )
                    )
                    print(
                        Colors.colorize(
                            "You'll need carbon-fiber bolts to use it.", Colors.YELLOW
                        )
                    )
                else:
                    weapon_name = weapon.get("name", "weapon") if weapon else "weapon"
                    print(
                        Colors.colorize(
                            f"You take careful aim with your {weapon_name} and fire!",
                            Colors.CYAN,
                        )
                    )
                    ...
                    enemy_subtype = ""
                    if enemy_type == "zombie" and enemy is not None:
                        enemy_subtype = enemy.get("type", "walker")
                    ...
                    base_crit_chance = weapon.get("critical_hit_chance", 0.25) if weapon else 0.25
                    # Marksmanship companions improve critical chance
                    if self.player and self.player.get("marksmanship_bonus", 0) > 0:
                        marksmanship_crit_bonus = min(
                            0.25, self.player.get("marksmanship_bonus", 0) * 0.5
                        )  # Up to 25% additional crit chance
                        crit_chance = base_crit_chance + marksmanship_crit_bonus
                        print(
                            Colors.colorize(
                                "Your marksmanship training improves your aim!",
                                Colors.GREEN,
                            )
                        )
                    else:
                    ...
                    if random.random() < crit_chance:
                        ...
                        if self.player.get("marksmanship_bonus", 0) > 0:
                            crit_multiplier = 1.5 + (
                                self.player.get("marksmanship_bonus", 0) * 0.5
                            )  # Up to +50% additional crit damage

                        bonus_damage += int(damage * (crit_multiplier - 1.0))
                        print(
                            Colors.colorize(
                                "Critical hit! The bolt strikes a vital area!",
                                Colors.GREEN,
                            )
                        )

                    # Ensure weapon, enemy, and player are valid
                    if weapon is None or enemy is None:
                        print("Error: weapon or enemy data is missing.")
                        return

                    # Extra effective against hazmat zombies
                    if (
                        enemy_type == "zombie"
                        and enemy.get("type", "walker") == "hazmat"
                    ):
                        penetration = weapon.get("hazmat_penetration", 0.85)
                        if random.random() < penetration:
                            print(
                                Colors.colorize(
                                    "The bolt penetrates the hazmat suit's protection!",
                                    Colors.GREEN,
                                )
                            )
                            bonus_damage += int(damage * 0.75)

                    # Base damage with bonuses
                    base_damage = damage + bonus_damage
                    total_damage = int(base_damage * companion_damage_bonus)

                    # Apply damage to enemy
                    enemy["health"] = max(0, enemy.get("health", 0) - total_damage)
                    print(
                        f"The {enemy.get('name', 'enemy')} takes {Colors.colorize(str(total_damage), Colors.RED)} damage!"
                    )

                    # Reduce ammo safely
                    weapon["ammo"] = max(0, weapon.get("ammo", 0) - 1)
                    print(
                        Colors.colorize(
                            f"Bolts remaining: {weapon['ammo']}/{weapon.get('max_ammo', 0)}",
                            Colors.YELLOW,
                        )
                    )

                    # Chance to recover bolt
                    base_recovery_chance = 0.7
                    marksmanship_bonus = self.player.get("marksmanship_bonus", 0)
                    recovery_chance = base_recovery_chance + min(
                        0.2, marksmanship_bonus * 0.5
                    )

                    if random.random() < recovery_chance:
                        print(
                            Colors.colorize(
                                "You'll be able to recover this bolt after combat.",
                                Colors.GREEN,
                            )
                        )
                        self.player["temp_recovered_bolts"] = (
                            self.player.get("temp_recovered_bolts", 0) + 1
                        )

                    elif weapon_id == "machete":
                        print(
                            Colors.colorize(
                                f"You swing your {weapon.get('name', 'machete')} in a wide arc!",
                                Colors.CYAN,
                            )
                        )
                        enemy_subtype = enemy.get("type", "walker")
                        ...
                        if enemy_type == "zombie" and enemy_subtype == "bloater":
                            ...
                            print(
                                Colors.colorize(
                                    "The blade slices deeply into the bloater's distended form!",
                                    Colors.GREEN,
                                )
                            )
                        ...
                        if random.random() < weapon.get("dismemberment_chance", 0.3):
                            print(
                                Colors.colorize(
                                    "You sever a limb with your precise strike!",
                                    Colors.GREEN,
                                )
                            )
                        ...
                        total_damage = int(
                            base_damage * blade_bonus * companion_damage_bonus
                        )
                        print(
                            Colors.colorize(
                                "Your blade mastery enhances the attack!", Colors.GREEN
                            )
                            if blade_bonus > 1.0
                            else ""
                        )
                        ...
                        if weapon.get("ammo", 0) <= 0:
                            print(
                                Colors.colorize(
                                    f"Your {weapon.get('name', 'M4 Carbine')} is out of ammunition!",
                                    Colors.RED,
                                )
                            )
                            print(
                                Colors.colorize(
                                    "You'll need 5.56mm rounds to use it again.",
                                    Colors.YELLOW,
                                )
                            )
                        else:
                            print(
                                Colors.colorize(
                                    f"You fire a burst from your {weapon.get('name', 'M4 Carbine')}!",
                                    Colors.CYAN,
                                )
                            )
                            enemy_subtype = enemy.get("type", "walker")
                    ...
                    if enemy_type == "zombie" and enemy_subtype == "military":
                        ...
                        print(
                            Colors.colorize(
                                "Your military-grade weapon is highly effective against the military zombie!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    if self.player.get("marksmanship_bonus", 0) > 0:
                        marksmanship_bonus = 1.0 + self.player.get(
                    ...
                    if companion_damage_bonus > 1.0 and marksmanship_bonus > 1.0:
                        bonus_hits = random.randint(
                            0, 2
                        )  # 0-2 additional hits with marksmanship companions
                        hits = base_hits + bonus_hits
                        if bonus_hits > 0:
                            print(
                                Colors.colorize(
                                    f"Your companion helps you place {bonus_hits} additional shots!",
                                    Colors.GREEN,
                                )
                            )
                    else:
                    ...
                    for i in range(hits):
                        ...
                        hit_damage = int(
                            base_damage * marksmanship_bonus * companion_damage_bonus
                        )
                        enemy["health"] -= hit_damage
                        total_damage += hit_damage

                    print(
                        f"The {hits}-round burst hits the {enemy['name']} for {Colors.colorize(str(total_damage), Colors.RED)} total damage!"
                    )
                    ...
                    print(
                        Colors.colorize(
                            f"Ammunition remaining: {weapon['ammo']}/{weapon['max_ammo']}",
                            Colors.YELLOW,
                        )
                    )
                    ...
                    if random.random() < 0.4:  # 40% chance
                        print(
                            Colors.colorize(
                                "The gunfire echoes in the distance, possibly attracting more zombies...",
                                Colors.RED,
                            )
                        )
                ...
                # Check if it has ammo
                if weapon and isinstance(weapon, dict) and weapon.get("ammo", 0) <= 0:
                    weapon_name = weapon.get("name", "flamethrower") 
                    print(
                        Colors.colorize(
                            f"Your {weapon_name} is out of fuel!", Colors.RED
                        )
                    )
                    print(
                        Colors.colorize(
                            "You'll need military-grade fuel canisters to use it again.",
                            Colors.YELLOW,
                        )
                    )
                else:
                    weapon_name = weapon.get('name', 'flamethrower') if weapon and isinstance(weapon, dict) else 'flamethrower'
                    print(
                        Colors.colorize(
                            f"You unleash a stream of fire from your {weapon_name}!",
                            Colors.YELLOW,
                    ...
                    enemy_subtype = enemy.get("type", "walker") if enemy else "walker"
                    bonus_damage = 0

                    # Extra effective against different enemy types
                    if enemy_type == "zombie":
                        if enemy_subtype == "bloater":
                            bonus_damage = weapon.get("bloater_damage_bonus", 50) if weapon else 50
                            print(
                                Colors.colorize(
                                    "The bloater's gas ignites in a violent explosion!",
                                    Colors.RED,
                            ...
                            bonus_damage = weapon.get("crawler_damage_bonus", 40) if weapon else 40
                            print(
                                Colors.colorize(
                                    "The flames completely engulf the low-lying crawler!",
                                    Colors.RED,
                                )
                            )
                    elif enemy_type == "animal":
                        # Animals take extra damage from fire
                        bonus_damage = weapon.get("animal_damage_bonus", 35) if weapon else 35
                        
                        # Safely get enemy name with a fallback
                        enemy_name = enemy.get('name', 'animal') if enemy and isinstance(enemy, dict) else 'animal'
                        print(
                            Colors.colorize(
                                f"The {enemy_name} panics in the flames!", Colors.RED
                            )
                        )
                    ...
                    if self.player.get("explosives_bonus", 0) > 0:
                        ...
                        print(
                            Colors.colorize(
                                "Your knowledge of incendiary weapons improves the effectiveness!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    base_damage = damage + bonus_damage
                    actual_damage = int(
                        base_damage * explosives_bonus * companion_damage_bonus
                    )
                    ...
                    if companion_damage_bonus > 1.0 and explosives_bonus > 1.0:
                        area_chance = (
                            0.8  # Increased to 80% with explosives specialist companion
                        )
                        print(
                            Colors.colorize(
                                "Your companion helps direct the flames for maximum area coverage!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    if random.random() < area_chance:
                        ...
                        print(
                            Colors.colorize(
                                f"The fire spreads, damaging nearby {enemy_type}s!",
                                Colors.YELLOW,
                            )
                        )
                        print(
                            f"Surrounding enemies take {Colors.colorize(str(area_damage), Colors.RED)} damage."
                        )
                    ...
                    if weapon and isinstance(weapon, dict):
                        ...
                        weapon["ammo"] = max(0, weapon.get("ammo", 0) - fuel_used)
                        print(
                            Colors.colorize(
                                f"Fuel remaining: {weapon.get('ammo', 0)}/{weapon.get('max_ammo', 0)}",
                                Colors.YELLOW,
                            )
                        )
                ...
                if weapon and isinstance(weapon, dict):
                    weapon_name = weapon.get('name', 'riot shield')
                    print(
                        Colors.colorize(
                            f"You brace behind your {weapon_name} and push forward!",
                            Colors.CYAN,
                        )
                    )
                    ...
                    print(
                        Colors.colorize(
                            "You brace behind your riot shield and push forward!",
                            Colors.CYAN,
                        )
                    )
                    base_defense_bonus = 25
                
                if self.player and isinstance(self.player, dict) and self.player.get("tactics_bonus", 0) > 0:
                    tactics_modifier = 1.0 + self.player.get("tactics_bonus", 0)
                    defense_bonus = int(base_defense_bonus * tactics_modifier)
                    print(
                        Colors.colorize(
                            "Your tactical training enhances your shield effectiveness!",
                            Colors.GREEN,
                        )
                    )
                else:
                ...
                print(
                    Colors.colorize(
                        f"Your defensive stance grants +{defense_bonus} protection against {enemy_type} attacks!",
                        Colors.GREEN,
                    )
                )
                ...
                if self.player and isinstance(self.player, dict) and self.player.get("tactics_bonus", 0) > 0:
                    stun_chance += min(
                        0.2, self.player.get("tactics_bonus", 0) * 0.5
                    )  # Up to 20% additional stun chance

                if random.random() < stun_chance:
                    # Safely get enemy name
                    enemy_name = enemy.get('name', 'enemy') if enemy and isinstance(enemy, dict) else 'enemy'
                    print(
                        Colors.colorize(
                            f"You bash the {enemy_name} with your shield, stunning it momentarily!",
                            Colors.GREEN,
                        )
                    )
                    
                    # Safely set player attribute
                    if self.player and isinstance(self.player, dict):
                ...
                # Apply damage with null safety check
                if enemy and isinstance(enemy, dict):
                    enemy["health"] = enemy.get("health", 100) - total_damage
                
                # Null safety check for enemy
                if enemy and isinstance(enemy, dict):
                    enemy_name = enemy.get('name', 'enemy')
                    print(
                        f"The {enemy_name} takes {Colors.colorize(str(total_damage), Colors.RED)} damage from the shield bash!"
                    )
                else:
                    print(
                        f"The enemy takes {Colors.colorize(str(total_damage), Colors.RED)} damage from the shield bash!"
                    )

            elif weapon_id == "sonic_disruptor":
                # Null safety check for weapon
                if not weapon or not isinstance(weapon, dict):
                    print(
                        Colors.colorize(
                            "Error: Weapon data is invalid.",
                            Colors.RED
                        )
                    )
                    return 0
                ...
                # Check if it has ammo
                if weapon.get("ammo", 0) <= 0:
                    weapon_name = weapon.get('name', 'sonic disruptor')
                    print(
                        Colors.colorize(
                            f"Your {weapon_name} has no power!", Colors.RED
                        )
                    )
                    print(
                        Colors.colorize(
                            "You'll need to find battery packs to use it again.",
                            Colors.YELLOW,
                        )
                    )
                else:
                    ...
                    print(
                        Colors.colorize(
                            f"You activate the {weapon_name}, sending out high-frequency sound waves!",
                            Colors.CYAN,
                        )
                    )
                    ...
                    # Safe access to weapon and enemy properties with null checks
                    stun_effect = False
                    if weapon and isinstance(weapon, dict):
                        stun_effect = weapon.get("stun_effect", False)
                        
                    enemy_subtype = "walker"
                    if enemy and isinstance(enemy, dict):
                        enemy_subtype = enemy.get("type", "walker")

                    # Apply engineering bonus - engineering specialists are better with tech weapons
                    tech_bonus = 1.0
                    if self.player and isinstance(self.player, dict) and self.player.get("engineering_bonus", 0) > 0:
                        tech_bonus = 1.0 + self.player.get("engineering_bonus", 0)
                        print(
                            Colors.colorize(
                                "Your engineering expertise improves the weapon's effectiveness!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    if enemy_type == "zombie":
                        ...
                        if enemy_subtype in ["screamer", "banshee"]:
                            bonus_damage = weapon.get(
                                "screamer_damage_bonus", 40
                            )  # Increased bonus damage
                            print(
                                Colors.colorize(
                                    "The sound waves are extremely effective against this sound-sensitive zombie!",
                                    Colors.GREEN,
                                )
                            )
                            print(
                                Colors.colorize(
                                    "The screamer's own sonic abilities are disrupted!",
                                    Colors.GREEN,
                                )
                            )
                            stun_effect = True
                            ...
                            if enemy and isinstance(enemy, dict) and "summoned_help" in enemy:
                                enemy["summoned_help"] = True
                        # Still effective but less powerful against other zombie types
                        else:
                            stun_effect = (
                                True  # All zombies can be stunned by sonic weapons
                            )
                            ...
                            if enemy_subtype == "crawler":
                                ...
                                print(
                                    Colors.colorize(
                                        "The sonic waves throw off the crawler's sensory perception!",
                                        Colors.GREEN,
                                    )
                                )
                        ...
                        bonus_damage = weapon.get("animal_damage_bonus", 30) if weapon and isinstance(weapon, dict) else 30
                        stun_effect = True
                        ...
                        print(
                            Colors.colorize(
                                f"The {enemy_name} recoils from the high-frequency sound!",
                                Colors.GREEN,
                            )
                        )
                        ...
                        print(
                            Colors.colorize(
                                f"The {enemy_name} covers their ears in pain!",
                                Colors.YELLOW,
                            )
                        )
                    ...
                    if companion_damage_bonus > 1.0 and tech_bonus > 1.0:
                        ...
                        print(
                            Colors.colorize(
                                "Your companion optimizes the weapon's frequency for maximum effect!",
                                Colors.GREEN,
                            )
                        )
                        stun_chance_bonus = (
                            0.2  # +20% stun chance with engineering companion
                        )
                    else:
                    ...
                    total_damage = int(
                        base_damage * tech_bonus * companion_damage_bonus
                    )
                    
                    # Apply damage safely with null check
                    if enemy and isinstance(enemy, dict):
                        enemy["health"] = enemy.get("health", 100) - total_damage
                    
                    # Get enemy name safely with null check
                    enemy_name = "enemy"
                    if enemy and isinstance(enemy, dict):
                        enemy_name = enemy.get("name", "enemy")
                    
                    print(
                        f"The {enemy_name} takes {Colors.colorize(str(total_damage), Colors.RED)} damage from the sonic attack!"
                    )

                    # Apply stun effect if applicable
                    stun_chance = (
                        0.7 + stun_chance_bonus
                    )  # Base 70% chance + possible bonus
                    if stun_effect and random.random() < stun_chance:
                        # Reuse the already safely retrieved enemy_name
                        print(
                            Colors.colorize(
                                f"The {enemy_name} is stunned by the sound waves!",
                                Colors.GREEN,
                            )
                        )
                        print(
                            Colors.colorize(
                                "It won't be able to attack this turn!", Colors.GREEN
                            )
                        )

                        # Skip the enemy's attack turn
                        if enemy and isinstance(enemy, dict) and enemy.get("health", 0) <= 0:
                            self.end_combat(True)
                        return
                    ...
                    ammo_cost = 1
                    if (
                        tech_bonus > 1.3 and random.random() < 0.3
                    ):  # 30% chance with high engineering skill
                        print(
                            Colors.colorize(
                                "Your engineering efficiency prevents power drain!",
                                Colors.GREEN,
                            )
                        )
                        ammo_cost = 0

                    # Update weapon ammo with null safety check
                    if weapon and isinstance(weapon, dict):
                        weapon["ammo"] = max(0, weapon.get("ammo", 0) - ammo_cost)
                        max_ammo = weapon.get("max_ammo", 1)
                        curr_ammo = weapon.get("ammo", 0)
                        print(
                            Colors.colorize(
                                f"Power remaining: {curr_ammo}/{max_ammo}",
                                Colors.CYAN,
                            )
                        )
            ...
            # Handle hazmat piercer (especially effective against hazmat zombies)
                ...
                weapon_name = "hazmat piercer"
                if weapon and isinstance(weapon, dict):
                    weapon_name = weapon.get("name", "hazmat piercer")
                
                print(
                    Colors.colorize(
                        f"You thrust the {weapon_name} forward with precision!",
                        Colors.CYAN,
                    )
                )
                ...
                if self.player.get("blade_bonus", 0) > 0:
                    precision_bonus = 1.0 + (
                        self.player.get("blade_bonus", 0) * 0.5
                    )  # 50% of blade bonus applies
                    print(
                        Colors.colorize(
                            "Your precise handling improves the piercing attack!",
                            Colors.GREEN,
                        )
                    )
                ...
                if (
                    ...
                    # Get enemy id and type with null safety
                    enemy_id = enemy.get("id", "")
                    enemy_type_str = enemy.get("type", "")

                    # Extra effective against hazmat zombies - with full null safety for string operations
                    if (
                        isinstance(enemy_id, str) and "hazmat" in enemy_id.lower()
                    ) or enemy_type_str == "hazmat":
                        # Safe access to weapon properties
                        if weapon is not None and isinstance(weapon, dict):
                            bonus_damage = weapon.get("hazmat_damage_bonus", 25)
                        else:
                            bonus_damage = 25  # Default if weapon dict isn't valid
                        print(
                            Colors.colorize(
                                "The piercer punctures through the protective suit with ease!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    # Effective against human armor with enhanced null safety
                    enemy_armor = enemy.get("armor", 0)
                    if enemy_armor > 0:
                        # Safely get weapon bonus and enemy name
                        if weapon is not None and isinstance(weapon, dict):
                            bonus_damage = weapon.get("armor_damage_bonus", 20)
                        else:
                            bonus_damage = (
                                20  # Default bonus if weapon dict isn't valid
                            )

                        enemy_name = enemy.get("name", "survivor")
                        print(
                            Colors.colorize(
                                f"The piercer finds a gap in {enemy_name}'s armor!",
                                Colors.GREEN,
                            )
                        )
                ...
                if companion_damage_bonus > 1.0 and precision_bonus > 1.0:
                    print(
                        Colors.colorize(
                            "Your companion helps you target a vital weak point!",
                            Colors.GREEN,
                        )
                    )
                    critical_chance = (
                        0.3  # 30% critical hit chance with blade master companion
                    )
                    if random.random() < critical_chance:
                        print(
                            Colors.colorize(
                                "CRITICAL HIT! The weapon strikes a vital point!",
                                Colors.RED + Colors.BOLD,
                            )
                        )
                        bonus_damage += int(damage * 0.5)  # +50% damage on critical

                # Calculate base damage with all bonuses with enhanced null safety
                if "damage" in locals():
                    base_damage = damage + bonus_damage
                else:
                    # Fallback if damage wasn't calculated properly earlier
                    if weapon is not None and isinstance(weapon, dict):
                        base_damage = weapon.get("damage", 10) + bonus_damage
                    else:
                        base_damage = 10 + bonus_damage  # Default value

                # Apply precision and companion damage bonuses
                total_damage = int(
                    base_damage * precision_bonus * companion_damage_bonus
                )

                # Update enemy health with null safety
                if enemy is not None and isinstance(enemy, dict) and "health" in enemy:
                    enemy["health"] -= total_damage
                    enemy_name = enemy.get("name", "enemy")
                    print(
                        f"The {enemy_name} takes {Colors.colorize(str(total_damage), Colors.RED)} damage!"
                    )

                    # Check if enemy is defeated with enhanced null safety
                    if enemy["health"] <= 0:
                        self.end_combat(True)
                        return
                else:
                    print(
                        f"Your attack deals {Colors.colorize(str(total_damage), Colors.RED)} damage!"
                    )

            # Handle tactical crossbow (silent weapon with retrievable ammo) with null safety
            elif (
                "weapon_id" in locals()
                and weapon_id == "tactical_crossbow"
                and weapon is not None
                and isinstance(weapon, dict)
            ):
                # Check if it has ammo with null safety
                if "ammo" in weapon and weapon["ammo"] <= 0:
                    weapon_name = weapon.get("name", "tactical crossbow")
                    print(
                        Colors.colorize(
                            f"Your {weapon_name} is not loaded!", Colors.RED
                        )
                    )
                    print(
                        Colors.colorize(
                            "You'll need to find crossbow bolts to use it again.",
                            Colors.YELLOW,
                        )
                    )
                elif "ammo" in weapon and weapon["ammo"] > 0:
                    weapon_name = weapon.get("name", "tactical crossbow")
                    print(
                        Colors.colorize(
                            f"You aim the {weapon_name} carefully and fire!",
                            Colors.CYAN,
                        )
                    )

                    # Get enemy type and subtype to check for special effects with null safety
                    enemy_subtype = (
                        enemy.get("type", "walker")
                        if enemy is not None and isinstance(enemy, dict)
                        else "walker"
                    )
                    ...
                    marksmanship_bonus = 1.0
                    if self.player and isinstance(self.player, dict) and self.player.get("marksmanship_bonus", 0) > 0:
                        marksmanship_bonus = (
                            1.0 + self.player.get("marksmanship_bonus", 0) * 1.5
                        )  # 150% of marksmanship bonus
                        print(
                            Colors.colorize(
                                "Your marksmanship training improves your accuracy!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    if enemy_type == "zombie":
                        # Check for enemy weaknesses with null safety checks
                        enemy_weakness = ""
                        if enemy and isinstance(enemy, dict):
                            enemy_weakness = enemy.get("weakness", "")
                            
                        if (
                            enemy_subtype == "hazmat"
                            or enemy_weakness == "piercing_weapons"
                        ):
                            # Get bonus with null safety
                            if weapon and isinstance(weapon, dict):
                                weakness_bonus = weapon.get(
                                    "hazmat_bonus", 3.0
                                )  # Triple damage against hazmat zombies
                            else:
                                weakness_bonus = 3.0  # Default bonus if weapon is None
                            print(
                                Colors.colorize(
                                    "The bolt pierces straight through the hazmat suit's protective material!",
                                    Colors.GREEN,
                                )
                            )
                            ...
                            if enemy_subtype == "hazmat":
                                print(
                                    Colors.colorize(
                                        "Toxic gas leaks from the punctured suit!",
                                        Colors.GREEN,
                                    )
                                )
                        ...
                        if enemy.get("armor", 0) > 0:
                            ...
                            print(
                                Colors.colorize(
                                    f"The bolt finds a gap in {enemy['name']}'s armor!",
                                    Colors.GREEN,
                                )
                            )

                    # Marksmanship companions improve critical hit chance
                    base_crit_chance = weapon.get(
                        "critical_chance", 0.25
                    )  # Base 25% chance
                    ...
                    if companion_damage_bonus > 1.0 and marksmanship_bonus > 1.0:
                        crit_chance_bonus = (
                            0.25  # +25% crit chance with marksmanship companion
                        )
                        print(
                            Colors.colorize(
                                "Your companion helps you aim for a vital point!",
                                Colors.GREEN,
                            )
                        )
                    ...
                    crit_chance = min(
                        base_crit_chance + crit_chance_bonus, 0.75
                    )  # Cap at 75% max
                    ...
                    if random.random() < crit_chance:
                        print(
                            Colors.colorize(
                                "CRITICAL HIT! The bolt strikes a vital point!",
                                Colors.RED + Colors.BOLD,
                            )
                        )
                    ...
                    # Apply damage with null safety check
                    if enemy and isinstance(enemy, dict):
                        current_health = enemy.get("health", 0)
                        enemy["health"] = max(0, current_health - total_damage)
                        
                        # Get enemy name with null safety
                        enemy_name = enemy.get("name", "enemy")
                        print(
                            f"The {enemy_name} takes {Colors.colorize(str(total_damage), Colors.RED)} damage from the bolt!"
                        )

                    # Improved retrievable ammo chance with marksmanship skills
                    base_retrieve_chance = 0.5
                    if weapon and isinstance(weapon, dict):
                    ...
                    retrieve_chance = min(
                        base_retrieve_chance + retrieve_bonus, 0.9
                    )  # Cap at 90%

                    # Check if enemy is defeated and if bolt can be retrieved
                    if (enemy and isinstance(enemy, dict) and enemy.get("health", 0) <= 0 
                        and random.random() < retrieve_chance):
                        # Get enemy name with null safety
                        enemy_name = enemy.get("name", "enemy")
                        print(
                            Colors.colorize(
                                f"You were able to retrieve your bolt from the {enemy_name}'s body.",
                                Colors.GREEN,
                            )
                        )
                    else:
                        # Use ammo with null safety check
                        if weapon and isinstance(weapon, dict):
                            # Update ammo safely
                            current_ammo = weapon.get("ammo", 0)
                            max_ammo = weapon.get("max_ammo", 1)
                            ...
                            print(
                                Colors.colorize(
                                    f"Bolts remaining: {weapon.get('ammo', 0)}/{max_ammo}",
                                    Colors.YELLOW,
                                )
                            )

                    # Silent weapon - less chance of attracting more enemies
                    if weapon and isinstance(weapon, dict) and weapon.get("silent", False) and random.random() < 0.9:
                        print(
                            Colors.colorize(
                                "The silent attack doesn't attract any additional attention.",
                                Colors.GREEN,
                            )
                        )
            ...
            # Handle riot shield (defensive weapon with less damage but defense bonus)
                ...
                print(
                    Colors.colorize(
                        f"You bash forward with your {weapon['name']}!", Colors.CYAN
                    )
                )

                # Ensure enemy and weapon are valid dictionaries
                if enemy is None or not isinstance(enemy, dict):
                    print("Error: 'enemy' is not defined properly.")
                    return

                if weapon is None or not isinstance(weapon, dict):
                    print("Error: 'weapon' is not defined properly.")
                    return

                # Apply damage
                enemy["health"] = enemy.get("health", 0) - damage  # fallback to 0 if "health" key missing
                print(
                    f"The {enemy.get('name', 'Unknown Enemy')} takes {Colors.colorize(str(damage), Colors.RED)} damage!"
                )
                ...
                print(
                    Colors.colorize(
                        f"You brace behind your shield, reducing incoming damage by {defense_bonus}!",
                        Colors.GREEN,
                    )
                )
                ...
                # Skip to enemy's attack if not defeated - with null safety
                if (
                    enemy is not None
                    and isinstance(enemy, dict)
                    and enemy.get("health", 0) <= 0
            ...
            # Check if weapon uses ammo - with proper null safety
            elif weapon is not None and isinstance(weapon, dict) and "ammo" in weapon:
                weapon_name = weapon.get("name", "weapon")
                current_ammo = weapon.get("ammo", 0)
                ...
                if current_ammo <= 0:
                    print(
                        Colors.colorize(
                            f"Your {weapon_name} is out of ammo!", Colors.RED
                        )
                    )
                    damage = damage // 3  # Use as melee weapon, much less effective
                else:
                    weapon["ammo"] = current_ammo - 1
                    print(
                        Colors.colorize(
                            f"You fire your {weapon_name}! ({weapon['ammo']} ammo left)",
                            Colors.CYAN,
                        )
                    )
                    ...
                    if hardcore_mode and random.random() < 0.2:
                        print(
                            Colors.colorize(
                                "\n⚠️ The sound of gunfire may attract more zombies to this area!",
                                Colors.YELLOW,
                            )
                        )

            # Check if weapon has reach advantage (like spear) - with null safety
            elif (
                weapon is not None
                and isinstance(weapon, dict)
                and weapon.get("reach", 0) > 1
            ):
                # Get player level with safety
                player_level = 1
                if (
                    self.player
                    and isinstance(self.player, dict)
                    and "level" in self.player
                ):
                    player_level = max(1, self.player.get("level", 1))

                hit_chance = 0.8 + min(
                    0.05 * (player_level - 1), 0.15
                )  # Initialize hit_chance
                ...
                print(
                    Colors.colorize(
                        f"You attack with your {weapon_name}, keeping the zombie at a distance.",
                        Colors.CYAN,
                    )
                )

            # Reduce weapon durability (unless already handled, like with the molotov) - with null safety
            if (
                weapon is not None
                and isinstance(weapon, dict)
                and weapon_id != "molotov"
                and not weapon.get("aoe", False)
                and "durability" in weapon
            ):
                ...
                # Get current durability safely and update it
                current_durability = weapon.get("durability", 0)
                weapon["durability"] = max(0, current_durability - durability_loss)

                # Warn about low durability - with safe checks
                current_durability = weapon.get("durability", 0)
                if current_durability <= 20 and current_durability > 0:
                    print(
                        Colors.colorize(
                            f"⚠️ Your {weapon_name} is severely damaged and might break soon!",
                            Colors.YELLOW,
                        )
                    )
                ...
                if current_durability <= 0:
                    ...
                    # Make sure player is defined and has equipped_weapon before trying to remove it
                    if (
                        self.player
                        and isinstance(self.player, dict)
                        and "equipped_weapon" in self.player
        ...
        if self.player["equipped_weapon"] is not None or weapon is None:
            ...
            if current_weather == "foggy":
                ...
                print(
                    Colors.colorize(
                        "The thick fog makes it difficult to aim accurately.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "rainy":
                ...
                print(
                    Colors.colorize(
                        "The rain affects your grip and visibility.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "stormy":
                ...
                print(
                    Colors.colorize(
                        "The howling storm hampers your movements.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "windy":
                ...
                if weapon and "ammo" in weapon:
                    ...
                    print(
                        Colors.colorize(
                            "The strong winds make it difficult to aim!",
                            weather_info["color"],
                        )
                    )
                else:
                ...
                print(
                    Colors.colorize(
                        "The oppressive heat slows your reactions.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "cold":
                ...
                print(
                    Colors.colorize(
                        "The cold slows the zombie, making it easier to hit.",
                        weather_info["color"],
                    )
                )
            ...
            if hardcore_mode and self.player.get("broken_limb", False):
                ...
                print(
                    Colors.colorize(
                        "Your broken limb makes it difficult to fight effectively.",
                        Colors.YELLOW,
                    )
                )
            ...
            if random.random() < hit_chance:
                ...
                if current_weather == "stormy":
                    ...
                    crit_chance += (
                        0.02  # Cold weather allows for more deliberate strikes
                    )
                ...
                if hardcore_mode and random.random() < crit_chance:
                    ...
                    print(
                        Colors.colorize(
                            "⚡ CRITICAL HIT!", Colors.BOLD + Colors.YELLOW
                        )
                    )

                # Use the critical_hit variable to apply effects
                if critical_hit:
                    ...
                    if enemy and isinstance(enemy, dict):
                        ...
                        enemy_name = enemy.get("name", "enemy")
                        print(
                            f"You hit the {enemy_name} for {Colors.colorize(str(total_damage), Colors.RED)} damage!"
                        )
                ...
                if (
                    ...
                    if (
                        weapon_id in ["machete", "kitchen_knife"]
                        and random.random() < 0.3
                    ):
                        print(
                            Colors.colorize(
                                f"Your {weapon_name} causes the {enemy_type} to bleed!",
                                Colors.RED,
                            )
                        )
                        enemy["bleeding"] = True
                    ...
                    if (
                        weapon_id in ["baseball_bat", "reinforced_bat"]
                        and random.random() < 0.2
                    ):
                        print(
                            Colors.colorize(
                                f"Your {weapon_name} stuns the {enemy_type} temporarily!",
                                Colors.YELLOW,
                            )
                        )
                        enemy["stunned"] = True
            else:
                # Safe access to enemy name
                enemy_name = (
                    enemy.get("name", "enemy") if isinstance(enemy, dict) else "enemy"
                )
                print(Colors.colorize(f"You miss the {enemy_name}!", Colors.YELLOW))

            # Check if enemy is defeated (with safety check)
            if (
                enemy is not None
                and isinstance(enemy, dict)
                and enemy.get("health", 0) <= 0
                ...
                self.end_combat(True)
                return
            # Additional safety check to prevent None reference
            if enemy is None or not isinstance(enemy, dict):
                print(
                    Colors.colorize(
                        "Error: Enemy reference lost during combat. Ending encounter.",
                        Colors.RED,
                    )
                )
                self.end_combat(True)
        ...
        # Enemy attacks back (unless affected by status effects)
        # Process any status effects before enemy attack
        (
            damage_multiplier,
            speed_multiplier,
            status_message,
        ) = self.process_status_effects(enemy)

        # Display status effect message if any
        if status_message:
            print(status_message)

        # Safety check that enemy is a valid dictionary
        if enemy is None or not isinstance(enemy, dict):
            return  # Can't process turn for invalid enemy

        # Check if enemy is stunned via the status_effects system
        if (
            "status_effects" in enemy
            and isinstance(enemy["status_effects"], dict)
            and "stunned" in enemy["status_effects"]
            and enemy["status_effects"]["stunned"] > 0
        ):
            # This is handled by process_status_effects, but we need to skip the enemy turn
            return  # Skip enemy turn entirely
        # Check other conditions that prevent enemy turns
        elif "skip_turn" in enemy and enemy["skip_turn"]:
            # Safe access to enemy name
            enemy_name = enemy.get("name", "enemy")
            print(
                Colors.colorize(
                    f"The {enemy_name} is unable to attack this turn!", Colors.GREEN
                )
            )
            enemy["skip_turn"] = False  # Reset the flag
        # Legacy support for older stunned status
        elif hardcore_mode and enemy.get("stunned", False):
            print(
                Colors.colorize(
                    f"The {enemy_type} is stunned and cannot attack this turn!",
                    Colors.GREEN,
                )
            )
            ...
            dodge_bonus = 0
            if weapon and isinstance(weapon, dict) and weapon.get("reach", 0) > 1:
                dodge_bonus = (
                    0.15  # Harder for enemy to hit you if you have a reach weapon
                )

            # Apply speed multiplier from status effects (frozen enemies are slower)
            enemy_attack_speed = enemy.get("speed", 1.0) * speed_multiplier

            # Check if enemy is stunned from riot shield, sonic disruptor, or other sources
            if isinstance(self.player, dict) and self.player.get(
                "temp_stun_enemy", False
            ):
                # Safe access to enemy name
                enemy_name = enemy.get("name", "enemy")
                print(
                    Colors.colorize(
                        f"The {enemy_name} is stunned and cannot attack this turn!",
                        Colors.GREEN,
                    )
                )
            ...
            # Note: We don't need the legacy experimental weapon status effects section here
            # as it's already handled by the process_status_effects function
            # which was called earlier and returned the appropriate modifiers

            # Enemy attack chance calculation - incorporate status effect speed multiplier
            hit_chance = 0.6 + 0.1 * enemy_attack_speed - dodge_bonus
            ...
            if current_weather == "rainy":
                ...
                print(
                    Colors.colorize(
                        f"The rain slows the {enemy['name']}'s movements.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "stormy":
                ...
                print(
                    Colors.colorize(
                        f"The storm severely hampers the {enemy['name']}'s attack.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "foggy":
                ...
                print(
                    Colors.colorize(
                        f"The fog gives the {enemy['name']} a surprise advantage!",
                        weather_info["color"],
                    )
                )
            elif current_weather == "hot":
                ...
                print(
                    Colors.colorize(
                        f"The heat makes the {enemy['name']} more aggressive.",
                        weather_info["color"],
                    )
                )
            elif current_weather == "cold":
                ...
                print(
                    Colors.colorize(
                        f"The cold weather makes the {enemy['name']} sluggish.",
                        weather_info["color"],
                    )
                )
            ...
            if random.random() < hit_chance:
                # Safe access to enemy damage with fallback
                damage = enemy.get("damage", 10) if isinstance(enemy, dict) else 10

                # Apply damage reduction from frozen effect (with null safety)
                if (
                    isinstance(enemy, dict)
                    and "status_effects" in enemy
                    and isinstance(enemy["status_effects"], dict)
                    and "frozen" in enemy["status_effects"]
                ):
                    # In the new system, frozen is just a counter rather than a dictionary with slow_percent
                    slow_percent = 0.5  # Fixed 50% damage reduction
                    ...
                    print(
                        Colors.colorize(
                            f"The ice formations reduce {enemy_name}'s attack damage by {damage_reduction}!",
                            Colors.BLUE,
                        )
                    )
                ...
                if (
                    hardcore_mode
                    and isinstance(enemy, dict)
                    and enemy.get("boss", False)
                ):
                    # Tank has slam attack
                    if enemy.get("id") == "tank" and random.random() < 0.2:
                        print(
                            Colors.colorize(
                                "The Tank performs a devastating slam attack!",
                                Colors.BOLD + Colors.RED,
                            )
                        )
                        damage = int(damage * 1.5)
                        # Safe access to player stamina
                        if isinstance(self.player, dict) and "stamina" in self.player:
                            self.player["stamina"] = max(
                                0, self.player["stamina"] - 20
                            )  # Drains stamina
                        special_attack = True

                        # Chance to cause broken limb (with safety check)
                        if random.random() < 0.3 and isinstance(self.player, dict):
                            self.player["broken_limb"] = True
                            print(
                                Colors.colorize(
                                    "The impact breaks your limb! Movement will be impaired.",
                                    Colors.BOLD + Colors.RED,
                                )
                            )

                    # Screamer has disorienting attack (with null safety)
                    elif enemy.get("id") == "screamer" and random.random() < 0.25:
                        print(
                            Colors.colorize(
                                "The Screamer lets out an ear-piercing shriek!",
                                Colors.BOLD + Colors.RED,
                            )
                        )
                        ...
                        # Increases insanity (with proper safety checks)
                        if isinstance(self.player, dict):
                            insanity_increase = random.randint(5, 15)
                            current_insanity = self.player.get("insanity", 0)
                            self.player["insanity"] = min(
                                100, current_insanity + insanity_increase
                            )
                            print(
                                Colors.colorize(
                                    f"The shriek disturbs your mental state! (+{insanity_increase} insanity)",
                                    Colors.MAGENTA,
                                )
                            )

                    # Boomer has toxic attack (with null safety)
                    elif enemy.get("id") == "boomer" and random.random() < 0.3:
                        print(
                            Colors.colorize(
                                "The Boomer vomits toxic bile on you!",
                                Colors.BOLD + Colors.GREEN,
                            )
                        )
                        ...
                        # High chance of infection (with safety checks)
                        if random.random() < 0.7 and isinstance(self.player, dict):
                            self.player["infected"] = True
                            print(
                                Colors.colorize(
                                    "The toxic bile infects your wounds!", Colors.RED
                                )
                            )

                # Apply defense bonus from riot shield or other sources (with null safety)
                defense_bonus = 0
                if isinstance(self.player, dict):
                    ...
                    if defense_bonus > 0:
                        ...
                        damage = max(
                            1, damage - defense_bonus
                        )  # Ensure at least 1 damage
                        damage_reduced = original_damage - damage
                        print(
                            Colors.colorize(
                                f"Your defensive equipment absorbs {damage_reduced} damage!",
                                Colors.GREEN,
                            )
                        )
                ...
                # Print status effect damage reduction message with null safety
                if damage_multiplier < 1.0 and isinstance(enemy, dict):
                    damage_reduced = original_damage - damage
                    enemy_name = enemy.get("name", "enemy")
                    print(
                        Colors.colorize(
                            f"Status effects reduce {enemy_name}'s attack damage by {damage_reduced}!",
                            Colors.CYAN,
                        )
                    )

                # Apply military vehicle protection if in a vehicle (with null safety)
                if (
                    isinstance(self.player, dict)
                    and self.player.get("in_vehicle", False)
                    and self.player.get("current_vehicle")
                ):
                    vehicle = self.player.get("current_vehicle")
                    if isinstance(vehicle, dict) and vehicle.get("id") in [
                        "humvee",
                        "transport_truck",
                        "apc",
                    ]:
                        ...
                        if vehicle_protection > 0:
                            original_damage = damage
                            damage = max(
                                1, damage - vehicle_protection
                            )  # Ensure at least 1 damage
                            damage_reduced = original_damage - damage
                            print(
                                Colors.colorize(
                                    f"Your {vehicle.get('name', 'vehicle')} absorbs {damage_reduced} damage!",
                                    Colors.GREEN,
                                )
                            )

                # Apply damage to player (with null safety)
                if isinstance(self.player, dict):
                    current_health = self.player.get("health", 0)
                    self.player["health"] = current_health - damage

                # Print attack message (with null safety)
                if special_attack:
                    ...
                    print(
                        Colors.colorize(
                            f"The {enemy_name} hits you for {damage} damage!",
                            Colors.RED,
                        )
                    )

                # Infection chance in hardcore mode (from hostile entities) with null safety
                if (
                    hardcore_mode
                    and not special_attack
                    and isinstance(self.player, dict)
                    and not self.player.get("infected", False)
                ):
                    if random.random() < INFECTION_CHANCE:
                        ...
                        print(
                            Colors.colorize(
                                f"The {enemy_name}'s attack has infected you!",
                                Colors.RED,
                            )
                        )

                # Bleeding chance in hardcore mode with null safety
                if (
                    hardcore_mode
                    and isinstance(self.player, dict)
                    and not self.player.get("bleeding", False)
                ):
                    hunter_attack = (
                        isinstance(enemy, dict)
                        and enemy.get("id", "") == "hunter"
                        and random.random() < 0.4
                    )
                    if hunter_attack or random.random() < 0.15:
                        ...
                        print(
                            Colors.colorize(
                                f"The {enemy_name}'s attack has caused you to start bleeding!",
                                Colors.RED,
                            )
                        )

                # Check if player died (with null safety)
                if isinstance(self.player, dict) and self.player.get("health", 0) <= 0:
                    self.player["health"] = 0
                    self.end_combat(False)

                    # Record death in death log for hardcore mode (with null safety)
                    if isinstance(self.player, dict) and self.player.get(
                        "hardcore_mode", False
                    ):
                        if self.death_log is None:
                            self.death_log = self.load_death_log()
                        # Get enemy name for death cause with null safety
                        enemy_name = (
                            enemy.get("name", "Enemy")
                            if isinstance(enemy, dict)
                            else "Enemy"
                        ...
                        if PERMADEATH and os.path.exists(SAVE_FILE):
                            try:
                                ...
                                print(
                                    Colors.colorize(
                                        "\nHARDCORE MODE: Your save file has been deleted.",
                                        Colors.BOLD + Colors.RED,
                                    )
                                )
                            except Exception as e:
            ...
            if (
                ...
                print(
                    Colors.colorize(
                        "The Hunter's quick movements make it hard to keep your balance.",
                        Colors.YELLOW,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"You lose {stamina_loss} stamina trying to keep up.",
                        Colors.YELLOW,
                    )
                )
        ...
        print(
            f"Your Health: {Colors.colorize(player_health_text, player_health_color)}"
        )

        # Display additional info in hardcore mode
        if hardcore_mode:
            stamina_color = Colors.health_color(
                self.player["stamina"], self.player["max_stamina"]
            )
    ...
    def cmd_flee(self, *args):
        ...
        enemy = (
            self.current_zombie
            if hasattr(self, "current_zombie")
            else self.current_enemy
        )

        # Determine enemy type with proper null safety
        enemy_type = "zombie"  # Default
        if enemy is not None and isinstance(enemy, dict):
            if "animal" in enemy and enemy.get("animal", False):
                enemy_type = "animal"
            elif "hostile" in enemy and enemy.get("hostile", False) is True:
                enemy_type = "survivor"
        ...
        if hardcore_mode:
            ...
            if self.player.get("broken_limb", False):
                ...
                print(
                    Colors.colorize(
                        "Your broken limb makes running difficult!", Colors.RED
                    )
                )
            ...
            if self.player.get("insanity", 0) > 70:
                ...
                print(
                    Colors.colorize(
                        "Your panicked mind can't focus on escape routes!",
                        Colors.MAGENTA,
                    )
                )

        # Base flee chance calculation with different formulas based on enemy type
        if enemy_type == "zombie" and enemy:
            enemy_speed = enemy.get("speed", 1)
            player_level = self.player.get("level", 1)
            ...
            if enemy and enemy.get("boss", False):
                flee_chance -= 0.2
                print(
                    Colors.colorize(
                        "The powerful zombie makes escape difficult!",
                        Colors.RED
                    )
                )


        elif enemy_type == "animal" and enemy:
            ...
            flee_chance = (
                0.6
                - 0.1 * enemy.get("speed", 1)
                + 0.05 * self.player["level"]
                - stamina_penalty
            )
            ...
            if animal_type in ["bear", "boar"]:
                ...
                print(
                    Colors.colorize(
                        f"The large {animal_type} makes escape difficult!", Colors.RED
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"The {animal_type} is quick and might catch you!",
                        Colors.YELLOW,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"The small {animal_type} shouldn't be hard to escape from.",
                        Colors.GREEN,
                    )
                )

            # Special animal traits affect flee chance - with null safety
            if enemy is not None and isinstance(enemy, dict):
                if "pack_hunter" in enemy and enemy.get("pack_attack", False):
                    flee_chance -= 0.1  # Pack animals coordinate to cut off escape
                    print(
                        Colors.colorize(
                            "The pack is trying to surround you!", Colors.RED
                        )
                    )
                if "ambush" in enemy and enemy.get("ambush", False):
                    flee_chance -= 0.05  # Ambush predators are good at pursuit
                    print(
                        Colors.colorize("The predator is agile in pursuit!", Colors.RED)
                    )

        elif enemy_type == "survivor" and enemy is not None and isinstance(enemy, dict):
            # Survivors have equipment that affects flee chance
            flee_chance = (
                0.5
                - 0.05 * enemy.get("speed", 1)
                + 0.05 * self.player.get("level", 1)
                - stamina_penalty
            )

            # Armed survivors are more dangerous to flee from
            if "weapon" in enemy and enemy.get("weapon"):
                ...
                if isinstance(weapon, dict):
                    ...
                    if weapon_type == "ranged":
                        ...
                        print(
                            Colors.colorize(
                                "The survivor has a ranged weapon and might shoot you as you flee!",
                                Colors.RED,
                            )
                        )

            # Skilled survivors are harder to escape
            if "skills" in enemy and enemy.get("skills"):
                skills = enemy.get("skills")
                if isinstance(skills, dict):
                    if skills.get("tracking", False):
                        flee_chance -= 0.1
                        print(
                            Colors.colorize(
                                "The survivor has tracking skills!", Colors.RED
                            )
                        )
                    if skills.get("marksmanship", False):
                        flee_chance -= 0.05
                        print(
                            Colors.colorize(
                                "The survivor is an excellent marksman!", Colors.RED
                            )
                        )
        ...
        if current_weather == "rainy":
            ...
            print(
                Colors.colorize(
                    "The rain makes the ground slippery as you try to escape.",
                    weather_info["color"],
                )
            )
        elif current_weather == "stormy":
            ...
            print(
                Colors.colorize(
                    "The violent storm makes running difficult!", weather_info["color"]
                )
            )
        elif current_weather == "foggy":
            ...
            print(
                Colors.colorize(
                    "The fog provides cover for your escape attempt.",
                    weather_info["color"],
                )
            )
        elif current_weather == "hot":
            ...
            print(
                Colors.colorize(
                    "The heat saps your energy as you try to flee.",
                    weather_info["color"],
                )
            )
        elif current_weather == "cold":
            ...
            print(
                Colors.colorize(
                    "The cold makes your muscles stiffer as you attempt to run.",
                    weather_info["color"],
                )
            )
        ...
        if hardcore_mode:
            ...
            chance_color = (
                Colors.GREEN
                if chance_display > 50
                else Colors.YELLOW
                if chance_display > 25
                else Colors.RED
            )
        ...
        if random.random() < flee_chance:
            ...
            if enemy_type == "zombie":
                ...
                print(
                    Colors.colorize(
                        f"\nYou successfully escape from the {animal_type}!",
                        Colors.GREEN,
                    )
                )
            elif enemy_type == "survivor":
                print(
                    Colors.colorize(
                        "\nYou successfully escape from the hostile survivor!",
                        Colors.GREEN,
                    )
                )
            ...
            if hardcore_mode:
                ...
                if random.random() < 0.15:
                    ...
                    if len(self.player["inventory"]) > 0:
                        ...
                        print(
                            Colors.colorize(
                                f"In your haste, you drop your {dropped_item['name']}!",
                                Colors.RED,
                            )
                        )
                        ...
                        # Adjust equipped weapon index if necessary
                            ...
                            and self.player["equipped_weapon"] > dropped_idx
                        ):
                ...
                if random.random() < 0.1:
                    ...
                    print(
                        Colors.colorize(
                            f"You stumble while escaping and take {injury_damage} damage!",
                            Colors.RED,
                        )
                    )

                    # Chance of broken limb from fall
                    if random.random() < 0.2 and not self.player.get(
                        "broken_limb", False
                    ):
                        self.player["broken_limb"] = True
                        print(
                            Colors.colorize(
                                "You twist your ankle badly in the escape!", Colors.RED
                            )
                        )
            ...
            if enemy:
                ...
                print("[DEBUG] Enemy object is None — cannot get damage.")
                damage = 0
            ...
            if enemy_type == "zombie":
                ...
                if hardcore_mode:
                    ...
                    print(
                        Colors.colorize(
                            "The zombie catches you from behind as you try to run!",
                            Colors.RED,
                        )
                    )
                else:
                    print(
                        Colors.colorize(
                            "The zombie lunges at you as you turn to run!", Colors.RED
                        )
                    )

                # Apply damage to player
                enemy_name = enemy.get("name", "Unknown enemy") if enemy else "Unknown enemy"
                damage = enemy.get("damage", 0) if enemy else 0

                print(
                    Colors.colorize(
                        f"The {enemy_name} hits you for {damage} damage!", Colors.RED
                    )
                )
                ...
                if hardcore_mode:
                    ...
                    if (
                        not self.player.get("infected", False)
                        and random.random() < INFECTION_CHANCE * 1.5
                    ):
                        self.player["infected"] = True
                        print(
                            Colors.colorize(
                                "The enemy's attack has infected you!", Colors.RED
                            )
                        )

                    # Higher bleeding chance when caught fleeing
                    if (
                        not self.player.get("bleeding", False)
                        and random.random() < 0.25
                    ):
                        self.player["bleeding"] = True
                        print(
                            Colors.colorize(
                                "The enemy's attack has caused you to start bleeding!",
                                Colors.RED,
                            )
                        )

            elif enemy_type == "animal":
                animal_type = enemy.get("animal_type", "animal") if enemy else "animal"
                ...
                if animal_type in ["bear", "boar"]:
                    ...
                    print(
                        Colors.colorize(
                            f"The {animal_type} charges at you as you try to escape!",
                            Colors.RED,
                        )
                    )
                elif animal_type in ["wolf", "dog"]:
                    print(
                        Colors.colorize(
                            f"The {animal_type} leaps at your legs as you turn to run!",
                            Colors.RED,
                        )
                    )
                else:
                    print(
                        Colors.colorize(
                            f"The {animal_type} catches you as you try to escape!",
                            Colors.RED,
                        )
                    )

                # Apply damage to player with comprehensive null safety
                if self.player is not None and isinstance(self.player, dict):
                    player_health = self.player.get("health", 0)
                    self.player["health"] = max(0, player_health - damage)
                    ...
                    # Special effects for animals with safe access
                    if (
                        hardcore_mode
                        and animal_type in ["wolf", "bear"]
                        and not self.player.get("bleeding", False)
                    ):
                        if (
                            random.random() < 0.3
                        ):  # 30% chance of bleeding from predator attack
                            self.player["bleeding"] = True
                            print(
                                Colors.colorize(
                                    f"The {animal_type}'s attack has caused you to start bleeding!",
                                    Colors.RED,
                                )
                            )
                ...
                # Survivor attack mechanics with comprehensive null safety
                if "weapon" in enemy and enemy.get("weapon") is not None:
                    enemy_weapon = enemy.get("weapon")
                    if isinstance(enemy_weapon, dict):
                        weapon_type = enemy_weapon.get("type", "melee")
                        weapon_name = enemy_weapon.get("name", "weapon")

                        if (
                            weapon_type == "ranged" and random.random() < 0.4
                        ):  # 40% chance of getting shot while fleeing
                            # Ranged weapons do more damage when fleeing
                            damage_modifier = 1.5
                            damage = int(damage * damage_modifier)
                            print(
                                Colors.colorize(
                                    f"The survivor shoots you with their {weapon_name} as you run away!",
                                    Colors.RED,
                                )
                            )
                    else:
                        # Default weapon_name in case we're in the else block without it being defined in the if block
                        weapon_name = "weapon"
                        print(
                            Colors.colorize(
                                f"The survivor strikes you with their {weapon_name} as you try to escape!",
                                Colors.RED,
                            )
                        )
                else:
                    print(
                        Colors.colorize(
                            "The survivor lunges at you as you try to escape!",
                            Colors.RED,
                        )
                    )
                ...
                if self.player is not None and isinstance(self.player, dict):
                    ...
                    print(
                        Colors.colorize(
                            f"The hostile survivor hits you for {damage} damage!",
                            Colors.RED,
                        )
                    )

                    # Special effects for survivors with proper null safety
                    if (
                        hardcore_mode
                        and enemy is not None
                        and isinstance(enemy, dict)
                        and "weapon" in enemy
                        and enemy.get("weapon") is not None
                    ):
                        enemy_weapon = enemy.get("weapon")
                        if isinstance(enemy_weapon, dict):
                            weapon_damage_type = enemy_weapon.get(
                                "damage_type", "blunt"
                            )
                            if (
                                ...
                                if (
                                    random.random() < 0.2
                                ):  # 20% chance of bleeding from piercing weapons
                                    self.player["bleeding"] = True
                                    print(
                                        Colors.colorize(
                                            "The survivor's attack has caused you to start bleeding!",
                                            Colors.RED,
                                        )
                                    )

                # Mental trauma from failed escape - with proper null safety
                insanity_increase = random.randint(3, 8)

                if self.player is not None and isinstance(self.player, dict):
                    self.player["insanity"] = min(
                        100, self.player.get("insanity", 0) + insanity_increase
                    )

                    if insanity_increase > 5:
                        print(
                            Colors.colorize(
                                "The failed escape attempt increases your sense of hopelessness.",
                                Colors.MAGENTA,
                            )
                        )

            # Check if player died with proper null safety
            if (
                self.player is not None
                and isinstance(self.player, dict)
                and self.player.get("health", 0) <= 0
            ):
                self.player["health"] = 0
                    ...
                    if PERMADEATH:
                        ...
                        for save in save_slots:
                            slot_file = os.path.join(
                                SAVES_FOLDER, f"save_slot_{save['slot']}.json"
                            )
                            try:
                                os.remove(slot_file)
                                print(
                ...
                if enemy_type == "zombie":
                    print(
                        Colors.colorize(
                            "\n💀 You have died while trying to escape from the zombie... Game over.",
                            Colors.BOLD + Colors.RED,
                        )
                    )
                elif enemy_type == "animal":
                    ...
                    print(
                        Colors.colorize(
                            f"\n💀 You have died while trying to escape from the {animal_type}... Game over.",
                            Colors.BOLD + Colors.RED,
                        )
                    )
                elif enemy_type == "survivor":
                    print(
                        Colors.colorize(
                            "\n💀 You have died while trying to escape from the hostile survivor... Game over.",
                            Colors.BOLD + Colors.RED,
                        )
                    )
                else:
                    print(
                        Colors.colorize(
                            "\n💀 You have died while trying to escape... Game over.",
                            Colors.BOLD + Colors.RED,
                        )
                    )
            ...
            if enemy and isinstance(enemy, dict):
                ...
                health_color = Colors.health_color(health, max_health)
            else:
                health_color = Colors.health_color(0, 1)
                
            # Display player health with null safety
            player_health = 0
            player_max_health = 1
            if self.player and isinstance(self.player, dict):
                player_health = self.player.get("health", 0)
                player_max_health = self.player.get("max_health", 1)
            
            player_health_color = Colors.health_color(player_health, player_max_health)

            # Display appropriate enemy health information
            if enemy is None:
                enemy_health_text = "0/1"
            else:
                enemy_health_text = f"{enemy.get('health', 0)}/{enemy.get('max_health', 1)}"

            # Display enemy health based on type
            if enemy_type == "zombie":
                print(
            ...
            if hardcore_mode:
                ...
                if self.player.get("insanity", 0) > 50:
                    status_effects.append(
                        Colors.colorize("Mental Stress", Colors.MAGENTA)
                    )
                ...
                if enemy and enemy_type == "zombie" and enemy.get("special_abilities", []):
                    abilities = ", ".join(enemy["special_abilities"])
                    print(f"Zombie Abilities: {Colors.colorize(abilities, Colors.RED)}")
                elif enemy and enemy_type == "animal" and enemy.get("pack_attack", False):
                    print(f"Animal Trait: {Colors.colorize('Pack Hunter', Colors.RED)}")
                elif enemy and enemy_type == "survivor" and isinstance(enemy, dict) and "skills" in enemy:
    ...
    def end_combat(self, victory):
        ...
        if (
            (not hasattr(self, "current_zombie") and not hasattr(self, "current_enemy"))
            or (hasattr(self, "current_zombie") and not self.current_zombie)
            or (hasattr(self, "current_enemy") and not self.current_enemy)
        ):
            return

        # Determine enemy type with null safety
        enemy = (
            self.current_zombie
            if hasattr(self, "current_zombie")
            else self.current_enemy
        ...
        if victory:
            # Base XP gain is influenced by enemy's stats (with null safety)
            # Get enemy speed with null safety check
            enemy_speed = 1
            if enemy and isinstance(enemy, dict):
                enemy_speed = enemy.get("speed", 1)
            
            xp_gain = 20 + 10 * enemy_speed
            ...
            if enemy_type == "zombie":
                ...
                if enemy and isinstance(enemy, dict):
                    enemy_subtype = enemy.get("type")
                    enemy_name = enemy.get("name", "zombie")
                ...
                # Update player XP with null safety check
                if self.player and isinstance(self.player, dict):
                    current_xp = self.player.get("xp", 0)
                    self.player["xp"] = current_xp + xp_gain
                ...
                if isinstance(enemy, dict):
                    ...
                    loot_chance = 0  # or some default value
                ...
                item_types = ["material", "food", "medical"]  # default items

                if isinstance(enemy, dict) and enemy.get("type") == "stalker":
                    item_types = ["material", "material", "food", "medical"]
                ...
                if matching_items:
                    ...
                    if self.add_to_inventory(found_item_id):
                        found_item_name = found_item.get('name', 'an item')
                        
                        if enemy_type == "zombie":
                            print(f"You found {found_item_name} on the zombie!")
                        elif enemy_type == "animal":
                            # Get enemy name with null safety
                            enemy_name = "animal"
                            if enemy and isinstance(enemy, dict):
                            ...
                            print(
                                f"You found {found_item_name} near the defeated {enemy_name}!"
                            )
                        elif enemy_type == "survivor":
                            print(
                                f"You found {found_item_name} in the survivor's belongings!"
                            )
                        else:
                            print(f"You found {found_item_name} on the enemy!")
                ...
                animal_type = enemy.get("animal_type", "dog") if enemy else "dog"
                if animal_type in ["bear", "boar"]:
                    xp_gain += 20  # Dangerous large animals worth more XP

                if enemy and isinstance(enemy, dict) and "name" in enemy:
                ...
                if random.random() < 0.7:  # 70% chance to get animal loot
                    ...
                    if animal_type in animal_loot:
                        ...
                        if self.add_to_inventory(loot):
                            print(
                                Colors.colorize(
                                    f"You harvested: {ITEMS.get(loot, {'name': loot})['name']}",
                                    Colors.YELLOW,
                                )
                            )
                ...
                if enemy and isinstance(enemy, dict):
                    skills = enemy.get("skills", [])
                    if skills:
                        xp_gain += 5 * len(skills)

                    enemy_name = enemy.get("name", "unknown survivor")

                    print(f"\nYou defeated the hostile survivor {enemy_name}!")
                    print(f"Gained {xp_gain} XP!")

                    self.player["xp"] = self.player.get("xp", 0) + xp_gain
                    self.player["survivors_killed"] = self.player.get("survivors_killed", 0) + 1

                    self.check_mission_progress("kill_survivor", "hostile")

                    print(
                        Colors.colorize(
                            "You search the survivor's belongings:", Colors.YELLOW
                        )
                    )
                else:
                    print("Error: enemy data is invalid or missing.")
                ...
                if enemy and isinstance(enemy, dict):
                    ...
                    # handle missing or invalid enemy object here
                    print("Warning: enemy is None or not a dictionary")


                if weapon_data and random.random() < 0.4:
                    weapon_id = weapon_data.get("id", "knife")
                    if self.add_to_inventory(weapon_id):
                        print(
                            Colors.colorize(
                                f"- {ITEMS.get(weapon_id, {'name': weapon_id})['name']}",
                                Colors.YELLOW,
                            )
                        )
                        loot_found = True
                    ...
                    if weapon_data.get("ammo", 0) > 0 and random.random() < 0.6:
                        ammo_amount = random.randint(1, weapon_data["ammo"])
                        ammo_id = weapon_data.get("ammo_type", "pistol_ammo")
                        for _ in range(ammo_amount):
                            self.add_to_inventory(ammo_id)
                        print(
                            Colors.colorize(
                                f"- {ammo_amount}x {ITEMS.get(ammo_id, {'name': ammo_id})['name']}",
                                Colors.YELLOW,
                            )
                        )
                ...
                for _ in range(random.randint(0, 2)):
                    if random.random() < 0.5:
                        ...
                        if self.add_to_inventory(supply):
                            print(
                                Colors.colorize(
                                    f"- {ITEMS.get(supply, {'name': supply})['name']}",
                                    Colors.YELLOW,
                                )
                            )
                            loot_found = True
            ...
            if self.player.get("temp_recovered_bolts", 0) > 0:
                ...
                print(
                    Colors.colorize(
                        f"You recover {recovered_bolts} crossbow bolt(s) from the battlefield.",
                        Colors.GREEN,
                    )
                )
            ...
            # Different defeat messages based on enemy type (with null safety)
            if enemy_type == "zombie":
                print(
                    Colors.colorize(
                        "You were overwhelmed by the zombie!", Colors.RED + Colors.BOLD
                    )
                )
            elif enemy_type == "animal":
                animal_type = (
                    enemy.get("animal_type", "animal")
                    if isinstance(enemy, dict)
                    else "animal"
                )
                print(
                    Colors.colorize(
                        f"The {animal_type} was too much for you to handle!",
                        Colors.RED + Colors.BOLD,
                    )
                )
            elif enemy_type == "survivor":
                print(
                    Colors.colorize(
                        "The hostile survivor got the better of you!",
                        Colors.RED + Colors.BOLD,
                    )
                )

            # Record death in hardcore mode with proper cause (with null safety)
            if isinstance(self.player, dict) and self.player.get(
                "hardcore_mode", False
            ):
                if self.death_log is None:
        ...
        # Clear any temporary status effects that should end when combat ends
        # Only keeps effects that should persist after combat (like bleeding, infection)
        persistent_effects = ["bleeding", "infected"]

        # Clean up player status effects
        if "status_effects" in self.player:
            # Create a copy of keys to avoid modifying dictionary during iteration
            effect_keys = list(self.player["status_effects"].keys())
            for effect in effect_keys:
                if effect not in persistent_effects:
                    del self.player["status_effects"][effect]
                    print(
                        Colors.colorize(
                            f"Your {effect} effect has worn off after combat.",
                            Colors.CYAN,
                        )
                    )

        # Clean up enemy status effects if they still exist
        # This ensures we don't leave lingering status effects on enemies that could cause issues in later combats
        enemy = None
        if hasattr(self, "current_zombie") and self.current_zombie:
            enemy = self.current_zombie
        elif hasattr(self, "current_enemy") and self.current_enemy:
            enemy = self.current_enemy

        if enemy and "status_effects" in enemy:
            # Clear all temporary combat effects from the enemy
            # Since combat is over, there's no need to preserve any enemy status effects
            enemy["status_effects"] = {}

        # If we have any temporary enemy lists (for area effect weapons), clean those up too
        # Set nearby_enemies as a class attribute if it doesn't exist yet
        if not hasattr(self, "nearby_enemies"):
            self.nearby_enemies = []

        # Clean up any status effects from enemies in the list
        for nearby_enemy in self.nearby_enemies:
            if (
                nearby_enemy
                and isinstance(nearby_enemy, dict)
                and "status_effects" in nearby_enemy
            ):
        ...
        if args and len(args) > 0:
            try:
                ...
                if 1 <= slot_arg <= MAX_SAVE_SLOTS:
                    ...
                    print(
                        f"Invalid save slot. Please use a number between 1 and {MAX_SAVE_SLOTS}."
                    )
                    return
            except ValueError:
    ...
    def cmd_saves_list(self, *args):
        ...
        print(
            Colors.colorize(
                "SAVE SLOT MANAGEMENT".center(50), Colors.BOLD + Colors.YELLOW
            )
        )
        print(Colors.colorize(f"{divider}", Colors.RED))
        ...
        print(
            Colors.colorize(
                "AVAILABLE SAVE SLOTS".center(50), Colors.BOLD + Colors.CYAN
            )
        )
        print(Colors.colorize(f"{divider}", Colors.CYAN))
        ...
        if save_slots:
            ...
            for save in save_slots:
                ...
                # Display character info with colors
                character_info = (
                    f"Survivor: {Colors.colorize(save['name'], Colors.YELLOW)}, "
                )
                character_info += (
                    f"Level {Colors.colorize(str(save['level']), Colors.YELLOW)} "
                )
        ...
        print(
            f"  {Colors.colorize('/load [slot]', Colors.YELLOW)} - Load from a slot (1-5)"
        )
        print(
            f"  {Colors.colorize('/saves_list', Colors.YELLOW)} - Show this list of save slots"
        )
        ...
        print(
            Colors.colorize(
                "Every save is a story waiting to be continued...".center(50),
                Colors.MAGENTA,
            )
        )
    ...
    def cmd_map(self, *args):
        ...
        # Current location marker with safety checks
        current_loc = self.player.get("location", "camp")
        current_location = get_safe_location(current_loc, "camp")
        current_location_name = current_location.get("name", "Unknown Area")
        print(
            f"Current location: {Colors.colorize(current_location_name, Colors.BOLD + Colors.RED)}"
        )

        # Print location details with safety checks
        print(Colors.colorize("\nLocation Details:", Colors.BOLD + Colors.YELLOW))

        # Make sure LOCATIONS exists and is a dictionary
        if not isinstance(LOCATIONS, dict):
            print("Error: Location data not available.")
            return

        for loc_id, loc in LOCATIONS.items():
            # Safe access to location properties
            location_name = loc.get("name", f"Unknown Area ({loc_id})")
            danger_level = loc.get("danger_level", 0)
            danger = "⚠️" * danger_level if danger_level > 0 else "✓ Safe"

            if loc_id == current_loc:
                location_name = Colors.colorize(
                    f"► {location_name} ◄", Colors.BOLD + Colors.RED
                )

            # Safe access to visited locations with proper type checking
            locations_visited = self.player.get("locations_visited", [])
            if not isinstance(locations_visited, list):
                locations_visited = []

            visited = "✓" if loc_id in locations_visited else "?"

            print(f"{location_name} - Danger: {danger} - Visited: {visited}")

            if loc_id in locations_visited:
                # Safe access to resource types
                resource_types = loc.get("resource_types", [])
                if resource_types:
    ...
    def cmd_stats(self, *args):
        ...
        locations_text = (
            f"Locations Discovered: {len(p['locations_visited'])}/{len(LOCATIONS)}"
        )
    ...
    def cmd_time(self, *args):
        ...
        print(
            f"Weather: {Colors.colorize(self.player['current_weather'], Colors.CYAN)}"
        )
    ...
    def cmd_weather(self, *args):
        ...
        for i, weather in enumerate(forecast):
            ...
            forecast_time = Colors.colorize(
                f"In {(i+1)*6} hours ({time_str}) {time_period}: ", time_color
            )
            forecast_weather = Colors.colorize(
                f"{weather_symbol} {weather_name}", weather_color
            )
    ...
    def cmd_upgrade_camp(self, *args):
        ...
        if self.player["location"] != "camp":
            print(
                Colors.colorize(
                    "You must be at the camp to upgrade facilities!", Colors.RED
                )
            )
            return
        ...
        print(
            Colors.colorize(
                "Your camp can be upgraded to improve safety and survival odds.",
                Colors.YELLOW,
            )
        )
        print(
            Colors.colorize("Materials are required for each upgrade.", Colors.YELLOW)
        )
        ...
        for upgrade_id, upgrade in CAMP_UPGRADES.items():
            ...
            if level == 0:
                ...
                if level == max_level:
                    ...
                    status = Colors.colorize(
                        f"Level {level}/{max_level}", Colors.YELLOW
                    )
            ...
            print(
                f"{Colors.colorize(upgrade['name'], Colors.BOLD + Colors.CYAN)}: {status} {bar}"
            )
            print(f"  {Colors.colorize(upgrade['description'], Colors.BLUE)}")
            print(
                f"  {Colors.colorize('Benefit:', Colors.GREEN)} {upgrade['benefits']}"
            )
            ...
            if upgrade_id == "barricades" and level > 0:
                ...
                print(
                    f"  {Colors.colorize('Barricade HP:', Colors.YELLOW)} {Colors.colorize(f'{current_hp}/{max_hp} ({hp_percent:.1f}%)', hp_color)}"
                )

                if current_hp < max_hp * 0.25:
                    print(
                        f"  {Colors.colorize('⚠️ CRITICAL DAMAGE! Barricades need immediate repairs!', Colors.RED)}"
                    )
                elif current_hp < max_hp * 0.5:
                    print(
                        f"  {Colors.colorize('⚠️ WARNING: Barricades are significantly damaged!', Colors.YELLOW)}"
                    )
        ...
        print(
            f"Use {Colors.colorize('/upgrade_camp [facility_name]', Colors.GREEN)} to upgrade a specific facility."
        )
        print(
            f"Example: {Colors.colorize('/upgrade_camp shelter', Colors.GREEN)} to upgrade your shelter."
        )
        print(
            f"Repair barricades with {Colors.colorize('/repair_barricades', Colors.GREEN)}."
        )
    ...
    def upgrade_facility(self, facility_id):
        ...
        if current_level >= max_level:
            print(
                Colors.colorize(
                    f"Your {facility['name']} is already at maximum level!",
                    Colors.YELLOW,
                )
            )
            return
        ...
        print(
            Colors.colorize(
                f"\n=== UPGRADE {facility['name'].upper()} ===",
                Colors.BOLD + Colors.CYAN,
            )
        )
        print(
            f"Current level: {Colors.colorize(str(current_level), Colors.YELLOW)}/{Colors.colorize(str(max_level), Colors.GREEN)}"
        )
        ...
        for material, amount in materials_needed.items():
            ...
            if material in missing_materials:
                status = Colors.colorize(
                    f"MISSING {missing_materials[material]}", Colors.RED
                )
            else:
        ...
        if can_upgrade:
            ...
            print(
                Colors.colorize(
                    f"\nUpgrade successful! {facility['name']} is now level {facility['level']}!",
                    Colors.BOLD + Colors.GREEN,
                )
            )
            ...
            if facility_id == "workshop":
                print(
                    Colors.colorize(
                        "You can now craft more advanced items!", Colors.YELLOW
                    )
                )
            elif facility_id == "barricades":
                print(
                    Colors.colorize(
                        "Your camp is now better protected against zombie attacks!",
                        Colors.YELLOW,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        "Your garden will now produce more food over time!",
                        Colors.YELLOW,
                    )
                )
    ...
    def cmd_eat(self, *args):
        ...
        if not args:
            print(
                Colors.colorize(
                    "You need to specify what to eat. Usage: /eat [item_id]",
                    Colors.YELLOW,
                )
            )
        ...
        if item_index is None:
            print(
                Colors.colorize(
                    f"You don't have {item_id} in your inventory.", Colors.RED
                )
            )
            return
        ...
        if not item_data or item_data.get("type") != "food":
            print(
                Colors.colorize(
                    f"{item_data.get('name', item_id)} is not edible!", Colors.RED
                )
            )
            return
        ...
        if has_pills:
            ...
            print(
                Colors.colorize(
                    "You take some medicine before eating to prevent illness.",
                    Colors.CYAN,
                )
            )
        ...
        old_hunger = self.player["hunger"]
        self.player["hunger"] = min(
            self.player["max_hunger"], old_hunger + hunger_value
        )
        hunger_gain = self.player["hunger"] - old_hunger

        hunger_message = (
            f"Hunger: {old_hunger} → {self.player['hunger']} (+{hunger_gain})"
        )
        ...
        if health_value > 0:
            old_health = self.player["health"]
            self.player["health"] = min(
                self.player["max_health"], old_health + health_value
            )
            health_gain = self.player["health"] - old_health

            health_message = (
                f"Health: {old_health} → {self.player['health']} (+{health_gain})"
            )
        ...
        if thirst_value > 0:
            old_thirst = self.player["thirst"]
            self.player["thirst"] = min(
                self.player["max_thirst"], old_thirst + thirst_value
            )
            thirst_gain = self.player["thirst"] - old_thirst

            thirst_message = (
                f"Thirst: {old_thirst} → {self.player['thirst']} (+{thirst_gain})"
            )
        ...
        if random.randint(1, 100) > safety_prob:
            ...
            recovery_chance = item_data.get(
                "recovery_chance", 80
            )  # 80% chance of recovery by default
            ...
            if random.randint(1, 100) <= recovery_chance:
                ...
                print(
                    Colors.colorize(
                        f"You feel sick for a while, losing {health_loss} health.",
                        Colors.YELLOW,
                    )
                )
                print(
                    Colors.colorize(
                        "Fortunately, you recover after a few hours of discomfort.",
                        Colors.GREEN,
                    )
                )
                ...
                if self.player.get("hardcore_mode", False):
                    ...
                    print(
                        Colors.colorize(
                            "The illness has left you fatigued.", Colors.YELLOW
                        )
                    )
            else:
                ...
                print(
                    Colors.colorize(
                        "\n⚠️ You've contracted SEVERE FOOD POISONING!",
                        Colors.BOLD + Colors.RED,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"You lose {health_loss} health from the poisoning!", Colors.RED
                    )
                )
                ...
                if self.player["health"] <= 0:
                    ...
                    print(
                        Colors.colorize(
                            "You barely survive the ordeal, but are severely weakened.",
                            Colors.YELLOW,
                        )
                    )
                    ...
                    if self.player.get("hardcore_mode", False):
                        ...
                        print(
                            Colors.colorize(
                                "You've developed an infection that will continue to weaken you.",
                                Colors.RED,
                            )
                        )
    ...
    def cmd_dismantle(self, *args):
        ...
        if self.in_combat:
            print(
                Colors.colorize("You can't dismantle items during combat!", Colors.RED)
            )
            return
        ...
        if not args:
            ...
            print(
                Colors.colorize(
                    "This command breaks down weapons and items into their component parts.\n",
                    Colors.CYAN,
                )
            )
            ...
            if dismantlable_items:
                ...
                for idx, item in dismantlable_items:
                    print(
                        f"{idx}. {Colors.colorize(ITEMS[item['id']]['name'], Colors.YELLOW)} "
                        + f"(x{item['count']})"
                    )
            else:
                print(
                    Colors.colorize(
                        "You don't have any items that can be dismantled.", Colors.RED
                    )
                )
            return
        ...
        try:
            ...
            if self.player.get("equipped") == item_id:
                print(
                    Colors.colorize(
                        "You can't dismantle your equipped weapon!", Colors.RED
                    )
                )
                return
            ...
            if "dismantle_yield" in item_data:
                ...
                print(
                    Colors.colorize(
                        f"The {ITEMS[item_id]['name']} cannot be dismantled.",
                        Colors.RED,
                    )
                )
                return
            ...
            if random.random() < 0.1:  # 10% chance
                self.player["crafting_skill"] = min(
                    10, self.player.get("crafting_skill", 0) + 1
                )
                print(
                    Colors.colorize(
                        "\nYou've gained insight into how things are assembled. Crafting skill improved!",
                        Colors.MAGENTA,
                    )
                )
    ...
    def cmd_repair_barricades(self, *args):
        ...
        if self.player["location"] != "camp":
            print(
                Colors.colorize(
                    "You must be at the camp to repair barricades!", Colors.RED
                )
            )
            return
        ...
        if CAMP_UPGRADES["barricades"]["level"] == 0:
            ...
            print(
                f"Use {Colors.colorize('/upgrade_camp barricades', Colors.GREEN)} to build them first."
            )
            return
        ...
        if barricades["hp"] >= barricades["max_hp"]:
            print(
                Colors.colorize(
                    "The barricades are already in perfect condition!", Colors.GREEN
                )
            )
            return
        ...
        print(
            f"Current status: {Colors.colorize(f'{current_hp}/{max_hp} HP ({hp_percentage:.1f}%)', hp_color)}"
        )
        ...
        if can_repair:
            ...
            for material, amount in materials_needed.items():
                ...
                for _, item in enumerate(
                    inventory_copy
                ):  # Using _ instead of idx as it's not used
                    if item.get("id") == material:
                        to_use = min(remaining, item.get("count", 1))
                        remaining -= to_use
            ...
            print(
                Colors.colorize(
                    "\nRepairs successful! The barricades are now fully restored!",
                    Colors.BOLD + Colors.GREEN,
                )
            )
    ...
    def cmd_scavenge_area(self, *args):
        ...
        current_location = self.player["location"]
        location_info = LOCATIONS[current_location]
        location_type = location_info.get(
            "type", "urban"
        ...
        # Ensure current_scavenging is properly initialized before access
        if not hasattr(self, "current_scavenging"):
            self.current_scavenging = None
            
        current_scavenging_area = None
        if self.current_scavenging is not None and isinstance(
            self.current_scavenging, dict
        ):
            current_scavenging_area = self.current_scavenging.get("area")

        if (
            self.current_scavenging is None
            or current_scavenging_area != area_id
        ):
            ...
            print(
                Colors.colorize(f"Risk Level: {'🔴' * area['risk_level']}", Colors.RED)
            )
        else:
            ...
            print(
                Colors.colorize(
                    f"\n=== CONTINUED SCAVENGING: Round {self.current_scavenging['round']} ===",
                    Colors.BOLD + Colors.CYAN,
                )
            )
            print(
                Colors.colorize(
                    f"Risk Level: {'🔴' * math.ceil(area['risk_level'] * self.current_scavenging['risk_modifier'])}",
                    Colors.RED,
                )
            )
            print(
                Colors.colorize(
                    f"Loot Quality: {'⭐' * math.ceil(self.current_scavenging['loot_modifier'])}",
                    Colors.YELLOW,
                )
            )
        ...
        if self.player["stamina"] < stamina_cost:
            print(
                Colors.colorize(
                    "You're too exhausted to continue scavenging!", Colors.RED
                )
            )
        ...
        print(
            Colors.colorize(
                f"Searching consumes {stamina_cost} stamina...", Colors.CYAN
            )
        )
        ...
        if random.random() < zombie_chance:
            print(
                Colors.colorize(
                    "\n❗ You've encountered a zombie while scavenging!",
                    Colors.BOLD + Colors.RED,
                )
            )
            ...
            if random.random() < special_zombie_chance:
                ...
                if area_id == "medical":
                    special_type = (
                        "spitter"  # Medical zombies often have toxic abilities
                    )
                elif area_id == "urban":
                ...
                print(
                    Colors.colorize(
                        f"It's a {ZOMBIE_TYPES[special_type]['name']}!",
                        Colors.BOLD + Colors.RED,
                    )
                )
        ...
        for _ in range(potential_items):  # Using _ since the index isn't used
            ...
            if random.random() < find_chance:
                ...
                special_item_chance = (
                    area["special_item_chance"]
                    * self.current_scavenging["loot_modifier"]
                )
                ...
                if self.add_to_inventory(item_id):
                    ...
                    print(
                        Colors.colorize(
                            "You found something, but your inventory is full!",
                            Colors.YELLOW,
                        )
                    )
                    break
        ...
        # Update game stats
        if (
            hasattr(self, "current_scavenging")
            and self.current_scavenging["items_found"]
        ):
            self.player["resources_gathered"] += len(
                self.current_scavenging["items_found"]
            )
        ...
        if not found_something:
            print(
                Colors.colorize(
                    "You searched thoroughly but didn't find anything useful.",
                    Colors.YELLOW,
                )
            )
        ...
        print(
            f"Items found this session: {len(self.current_scavenging['items_found'])}"
        )
        ...
        if self.player.get("hardcore_mode", False) and next_risk > 4:
            print(
                Colors.colorize(
                    "⚠️ WARNING: The risk of deadly encounters is extremely high!",
                    Colors.BOLD + Colors.RED,
                )
            )
    ...
    def cmd_quit(self, *args):
        ...
        confirm = input(
            Colors.colorize(
                "Are you sure you want to quit? Unsaved progress will be lost (y/n): ",
                Colors.YELLOW,
            )
        )
        if confirm.lower() == "y":
    ...
    def generate_random_name(self):
        ...
        # Names are organized with comments like "# Western names" in the lists
        # We'll find names by directly searching for the culture in the comment strings

        # Find the range of first names for this culture
        found_culture = False
        for name in SURVIVOR_FIRST_NAMES:
            if (
                isinstance(name, str)
                and name.startswith("#")
                and selected_culture in name.lower()
            ):
                found_culture = True
                continue
        ...
        found_culture = False
        for name in SURVIVOR_LAST_NAMES:
            if (
                isinstance(name, str)
                and name.startswith("#")
                and selected_culture in name.lower()
    ...
    def spawn_survivor(self, specific_type=None):
        ...
        if specific_type and specific_type in SURVIVOR_TYPES:
            ...
            danger_level = location["danger_level"]
            hostile_chance = min(
                0.2 + (danger_level * 0.1), 0.7
            )  # 20-70% chance based on danger
            ...
            if random.random() < hostile_chance:
                ...
                non_hostile_types = [
                    s_type
                    for s_type, data in SURVIVOR_TYPES.items()
        ...
        survivor["recruit_difficulty"] = survivor_template.get(
            "recruit_difficulty", "hard"
        )
    ...
    def spawn_animal(self, is_friendly=None, specific_type=None):
        ...
        if specific_type:
            if is_friendly and specific_type in FRIENDLY_ANIMALS:
                ...
                animal_type = self._select_random_animal_type(
                    is_friendly, location_animals
                )
        else:
        ...
        animal[
            "id"
        ] = f"animal_{int(time.time())}_{random.randint(1000, 9999)}"  # Unique ID
    ...
    def _select_random_animal_type(self, is_friendly, location_animals):
        ...
        if location_animals:
            if is_friendly:
                available_types = [
                    animal for animal in location_animals if animal in FRIENDLY_ANIMALS
                ]
                if not available_types:  # Fallback if no matching friendly animals
                    available_types = list(FRIENDLY_ANIMALS.keys())
            else:
                available_types = [
                    animal for animal in location_animals if animal in INFECTED_ANIMALS
                ]
    ...
    def encounter_survivor(self):
        ...
        if survivor["hostile"]:
            print(
                Colors.colorize(
                    "\nThis survivor seems hostile and is preparing to attack!",
                    Colors.RED,
                )
            )
            ...
            if "charisma" in self.player.get("skills", []) and random.random() < 0.4:
                print(
                    Colors.colorize(
                        "Your charisma helps you de-escalate the situation.",
                        Colors.GREEN,
                    )
                )
                print(
                    f"{survivor['name']} lowers their weapon and backs away cautiously."
                )
                return False
        ...
        if choice == "1":
            ...
            if survivor["cautious"] and random.random() < 0.3:
                print(
                    f"{survivor['name']} remains wary but shares some information with you."
                )
                self.peaceful_survivor_interaction(survivor)
            else:
                print(
                    f"{survivor['name']} seems relieved to meet another friendly face."
                )
            ...
            print(
                f"{survivor['name']} watches you leave, then disappears into the ruins."
            )
            ...
            print(
                f"{survivor['name']} gives you a cautious nod and continues on their way."
            )
    ...
    def peaceful_survivor_interaction(self, survivor):
        ...
        if info_type == "location":
            ...
            if unknown_locations:
                ...
                print(
                    Colors.colorize(
                        f"You've discovered {LOCATIONS[new_loc]['name']}!", Colors.GREEN
                    )
                )
            ...
            print(
                f"They describe the {zombie_info['name']} - {zombie_info['description'][:100]}..."
            )
            if "weakness" in zombie_info:
                print(
                    Colors.colorize(
                        f"Importantly, they mention it has a weakness to {zombie_info['weakness']}.",
                        Colors.GREEN,
                    )
                )
            ...
            print(
                Colors.colorize(
                    "Your next rest will be 20% safer thanks to this information.",
                    Colors.GREEN,
                )
            )
            ...
            print(
                Colors.colorize(
                    f"They share some crafting advice: {random.choice(crafting_tips)}",
                    Colors.GREEN,
                )
            )
    ...
    def trade_with_survivor(self, survivor):
        ...
        for _ in range(item_count):
            rarity = random.choices(
                list(item_chance.keys()), weights=list(item_chance.values())
            )[0]
            ...
            matching_items = [
                ...
                and item.get("type") in item_types
            ]
            ...
            try:
                ...
                if 1 <= choice <= len(trade_items):
                    ...
                    if self.player["supplies"] >= price:
                        ...
                        print(
                            Colors.colorize(
                                f"You purchased {ITEMS[item_id]['name']} for {price} supplies.",
                                Colors.GREEN,
                            )
                        )
                        ...
                        print(
                            Colors.colorize(
                                "You don't have enough supplies for that item.",
                                Colors.RED,
                            )
                        )
                else:
    ...
    def try_recruit_survivor(self, survivor):
        ...
        active_companions = [
            c
            for c in self.player.get("companions", [])
            if c.get("status", "active") == "active"
        ]
        if len(active_companions) >= 2:
            print(
                Colors.colorize(
                    "You can't recruit any more companions. You already have the maximum of 2 active companions in your group.",
                    Colors.RED,
                )
            )
            print(
                "You need to dismiss one of your current companions before recruiting someone new."
            )
            return False
        ...
        if random.random() < final_chance:
            ...
            print(
                Colors.colorize(
                    f"{survivor['name']} agrees to join your group!", Colors.GREEN
                )
            )
            ...
            if (
                len(active_companions) == 1
            ):  # This means we now have 2 active companions
                print(
                    Colors.colorize(
                        "\nYou now have 2 active companions, which is the maximum.",
                        Colors.YELLOW,
                    )
                )
                print(
                    "If you want to recruit someone else, you'll need to dismiss one of your current companions using the /dismiss [name] command."
                )
            ...
            print(
                Colors.colorize(
                    f"{survivor['name']} declines your offer to join.", Colors.RED
                )
            )
    ...
    def cmd_companions(self, *args):
        ...
        active_companions = [
            c for c in companions if c.get("status", "active") == "active"
        ]
        injured_companions = [c for c in companions if c.get("status") == "injured"]

        print(
            Colors.colorize(
                f"Active Companions: {len(active_companions)}/2", Colors.CYAN
            )
        )
        ...
        if active_companions:
            ...
            for i, companion in enumerate(active_companions):
                ...
                loyalty_str = (
                    "High" if loyalty >= 70 else "Medium" if loyalty >= 40 else "Low"
                )

                # Show companion's role/type
                companion_type = (
                    companion.get("survivor_type", "cautious_survivor")
                    .replace("_", " ")
                    .title()
                )
                ...
                skill_str = (
                    ", ".join(skill.replace("_", " ").title() for skill in skills)
                    if skills
                    else "None"
                )
                ...
                if weapon_spec:
                    print(
                        f"   Specialization: {Colors.colorize(weapon_spec, Colors.GREEN)}"
                    )
                print("")
        ...
        if injured_companions:
            ...
            for i, companion in enumerate(injured_companions):
                ...
                print(
                    f"{i+1}. {Colors.colorize(name, Colors.RED)} - Recovering ({recovery_time} hours until ready)"
                )
    ...
    def cmd_dismiss(self, *args):
        ...
        if not args:
            print(
                Colors.colorize(
                    "You need to specify which companion to dismiss.", Colors.YELLOW
                )
            )
        ...
        if not companions:
            print(
                Colors.colorize("You don't have any companions to dismiss.", Colors.RED)
            )
            return
        ...
        if dismissed and dismissed_companion:
            ...
            if "skills" in dismissed_companion and dismissed_companion["skills"]:
                print(
                    Colors.colorize(
                        "Your group's capabilities have been adjusted due to the departure.",
                        Colors.YELLOW,
                    )
                )
            ...
            print(
                Colors.colorize(
                    f"You don't have a companion named '{companion_name}'.", Colors.RED
                )
            )
    ...
    def apply_companion_skills(self, companion):
        ...
        if "weapon_specialization" in companion:
            ...
            companion_id = companion.get(
                "id", str(len(self.player.get("companions", [])))
            )
            self.player["companion_weapon_specializations"][companion_id] = companion[
            ...
            print(
                Colors.colorize(
                    f"{companion['name']} is specialized in {weapon_type} weapons (+{bonus_percent}% damage).",
                    Colors.GREEN,
                )
            )
        ...
        for skill in skills:
            if skill == "medical":
                ...
                print(
                    Colors.colorize(
                        "Your group's medical effectiveness has improved.", Colors.GREEN
                    )
                )

            elif skill == "crafting":
                self.player["crafting_bonus"] = (
                    self.player.get("crafting_bonus", 0) + 0.15
                )
                print(
                    Colors.colorize(
                        "Your group's crafting efficiency has improved.", Colors.GREEN
                    )
                )

            elif skill == "hunting":
                self.player["food_find_bonus"] = (
                    self.player.get("food_find_bonus", 0) + 0.25
                )
                print(
                    Colors.colorize(
                        "Your group will find more food while exploring.", Colors.GREEN
                    )
                )
                ...
                print(
                    Colors.colorize(
                        "Your group's combat effectiveness has improved.", Colors.GREEN
                    )
                )
                ...
                print(
                    Colors.colorize(
                        "Your group can move more quietly now.", Colors.GREEN
                    )
                )
                ...
                print(
                    Colors.colorize(
                        "Your group's repair and building capabilities have improved.",
                        Colors.GREEN,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"{companion['name']} improves your group's accuracy with ranged weapons.",
                        Colors.GREEN,
                    )
                )

            elif skill == "explosives":
                self.player["explosive_bonus"] = (
                    self.player.get("explosive_bonus", 0) + 0.3
                )
                print(
                    Colors.colorize(
                        f"{companion['name']} knows how to maximize explosive damage.",
                        Colors.GREEN,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"{companion['name']} is skilled with blade weapons.",
                        Colors.GREEN,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"{companion['name']} provides tactical combat advice to the group.",
                        Colors.GREEN,
                    )
                )
    ...
    def encounter_animal(self):
        ...
        if is_friendly:
            ...
            if animal.get("companion_potential", False):
                ...
                if choice == "1":
                    ...
                    if random.random() < success_chance:
                        ...
                        print(
                            Colors.colorize(
                                f"The {animal['name']} cautiously approaches and accepts your friendship!",
                                Colors.GREEN,
                            )
                        )
                        ...
                        if animal.get("detection_bonus"):
                            self.player["detection_bonus"] = (
                                self.player.get("detection_bonus", 0)
                                + animal["detection_bonus"]
                            )
                            print(
                                Colors.colorize(
                                    f"{animal['given_name']} will help detect threats before they notice you.",
                                    Colors.GREEN,
                                )
                            )

                        if animal.get("stealth_bonus"):
                            self.player["stealth_bonus"] = (
                                self.player.get("stealth_bonus", 0)
                                + animal["stealth_bonus"]
                            )
                            print(
                                Colors.colorize(
                                    f"{animal['given_name']} will help you move more quietly.",
                                    Colors.GREEN,
                                )
                            )
                    else:
                        ...
                        print(
                            Colors.colorize(
                                f"The {animal['name']} is too cautious and backs away.",
                                Colors.RED,
                            )
                        )
                ...
                if choice == "1":
                    ...
                    camp_upgrade_level = self.player.get("camp_upgrades", {}).get(
                        "livestock_pen", 0
                    )
                    ...
                    if camp_upgrade_level > 0:
                        ...
                        print(
                            Colors.colorize(
                                f"When you return to camp, the {animal['name']} will be added to your livestock pen.",
                                Colors.GREEN,
                            )
                        )
                        ...
                        if animal.get("food_production", False):
                            print(
                                Colors.colorize(
                                    "This will provide a steady source of food.",
                                    Colors.GREEN,
                                )
                            )
                    else:
                        print(
                            Colors.colorize(
                                "You don't have a livestock pen at your camp. You need to build one first.",
                                Colors.RED,
                            )
                        )
            ...
            print(
                Colors.colorize(
                    f"\nThe {animal['name']} appears aggressive and infected!",
                    Colors.RED,
                )
            )
            ...
            if animal.get("pack_hunter", False) and animal.get("calls_pack", False):
                ...
                print(
                    Colors.colorize(
                        f"You realize this isn't just one {animal['name']} - it's a pack of {pack_size}!",
                        Colors.RED,
                    )
                )
                print(
                    "The infected animals begin to circle you, coordinating their attack."
                )

                # Increase difficulty for pack animals
                animal["damage"] = int(animal["damage"] * 1.2)
                animal["health"] = int(
                    animal["health"] * pack_size * 0.7
                )  # Not full multiplier to keep it balanced
            ...
            if animal.get("ambush", False) and random.random() < 0.7:
                print(
                    Colors.colorize(
                        f"The {animal['name']} lunges at you before you can react!",
                        Colors.RED,
                    )
                )
                ...
                print(
                    Colors.colorize(
                        f"You take {damage} damage from the surprise attack!",
                        Colors.RED,
                    )
                )
