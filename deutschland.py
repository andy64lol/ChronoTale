...
ENDINGS = {
    ...
    "fuhrers_reich": {
        ...
        "description": "Under your leadership, the Third Reich has achieved total domination of Europe. Fascism reigns supreme, and Germany stands as the uncontested hegemon of the continent. The thousand-year Reich that Hitler envisioned has become reality.",
        "requirements": {
            "government": "Fascist",
            "conquered_nations": ["france", "poland", "belgium", "netherlands", "denmark", "norway", "yugoslavia"],
            "year_min": 1940
        },
        "type": "victory"
    },
    "marx_revival": {
        ...
        "description": "The Communist revolution has succeeded in Germany! The workers have cast off their chains and established a true proletarian state. Karl Marx's vision of a communist Germany has been realized, and the revolution is spreading across Europe.",
        "requirements": {
    ...
    "center_of_democracy": {
        ...
        "description": "Germany has transformed into a beacon of democratic values in the heart of Europe. Rejecting both fascism and communism, you have established a stable, prosperous democratic state that serves as a model for other nations.",
        "requirements": {
    ...
    "european_union": {
        ...
        "description": "Rather than conquest, Germany has led the formation of a peaceful European Union. Nations have voluntarily joined this new economic and political alliance, creating unprecedented cooperation and prosperity across the continent.",
        "requirements": {
            "government": "Democratic",
    ...
    "kaiser_return": {
        ...
        "description": "The monarchy has been restored! The Hohenzollern dynasty once again sits on the German throne. The Kaiser rules with a firm but fair hand, and Germany returns to its imperial glory while maintaining modern governance.",
        "requirements": {
    ...
    "greater_germanic_reich": {
        ...
        "description": "The dream of a unified Germanic Empire has been realized! All German-speaking peoples and territories are now united under the glorious banner of the Reich. Austria, Switzerland, the Sudetenland, Alsace-Lorraine, Luxembourg, and German enclaves throughout Europe have been incorporated into a single, mighty Germanic state that dominates Central Europe. The borders now reflect the true ethnic and cultural boundaries of the Germanic peoples. This is not merely a conquest but a historical reunification, fulfilling the ancient vision of a united Volk. With the combined industrial might, cultural heritage, and military power of all Germanic peoples, a new continental superpower has emerged that will shape the destiny of Europe for a thousand years to come.",
        "requirements": {
            "government": "Fascist",
    ...
    "global_socialist_republic": {
        ...
        "description": "Germany has become the center of a worldwide socialist revolution. Together with the Soviet Union, you have spread communism across Europe and beyond. The workers of the world have truly united, just as Marx and Engels envisioned.",
        "requirements": {
            "government": "Communist",
    ...
    "new_rhineland": {
        ...
        "description": "A new democratic federation has emerged in the heart of Europe, centered around the Rhine river. Germany has embraced democratic values and formed a peaceful federation with its western neighbors, creating a powerful economic and political union. This federation serves as a bulwark against both fascism and communism, ensuring peace and prosperity for its citizens. The Rhineland, once a contested region, now stands as the symbol of European cooperation and unity.",
        "requirements": {
            "government": "Democratic",
    ...
    "kaisers_great_return": {
        ...
        "description": "The German monarchy has been restored with unprecedented power. Kaiser Wilhelm III rules a new German Reich that encompasses much of Europe. This neo-feudal empire combines modern industry with traditional aristocratic values, creating a unique socioeconomic system that rejects both communism and liberal democracy.",
        "requirements": {
            "government": "Monarchist",
            "stability": 80,
    ...
    "marxist_united_earth": {
        ...
        "description": "What began as a German revolution has transformed into a global communist utopia. The boundaries between nations have dissolved as workers everywhere rise up against capitalism. Earth is now unified under a single Marxist government, with Berlin as its capital. Humanity stands ready to spread the revolution to the stars.",
        "requirements": {
            "government": "Communist",
    ...
    "popes_roman_empire": {
        ...
        "description": "In a shocking turn of events, Germany has formed an alliance with the Vatican to create a new Holy Roman Empire. This theocratic state unites German military might with Catholic spiritual authority. The Pope and Kaiser rule as dual sovereigns over a Europe returning to faith-based governance in the modern age.",
        "requirements": {
            "government": "Monarchist",
            "stability": 75,
    ...
    "one_banner_union": {
        ...
        "description": "All German-speaking peoples and territories have been united under a single flag. This Greater Germania includes not just Germany and Austria, but parts of Switzerland, Poland, Czechoslovakia, and beyond. Cultural unity and shared language form the foundation of this new ethnic state that fulfills the dream of a unified German people.",
        "requirements": {
    ...
    "center_of_germania": {
        ...
        "description": "Beyond mere German unity, you've created a pan-Germanic federation uniting all Germanic peoples. Germans, Dutch, Danes, Swedes, Norwegians, and even the English are now part of a single cultural and political entity bound by their shared linguistic heritage. This Germanic Union stands as a formidable power bloc dominating northern Europe.",
        "requirements": {
    ...
    "satanist_theocracy": {
        ...
        "description": "What began as political reform has devolved into something far darker. A radical occult movement has seized control of Germany, establishing a state-sponsored satanic church. Ancient pagan rituals blend with modern fascist aesthetics in this bizarre theocracy that terrifies and fascinates the world in equal measure.",
        "requirements": {
            "stability": 50,
            "war_support": 90,
            "year_min": 1940,
    ...
    "permanent_civil_war": {
        ...
        "description": "Germany has descended into chaos. Multiple factions fight for control, and the nation is torn apart by a never-ending civil war. The dream of a unified Germany lies in ruins as warlords carve out territories across the former reich.",
        "requirements": {
            "stability": 20,
            "war_support": 90,
    ...
    "nuclear_annihilation": {
        ...
        "description": "The war has escalated beyond all control. Experimental atomic weapons have been deployed against German cities. Berlin is a radioactive crater, and millions are dead. Germany as a nation has effectively ceased to exist in the atomic fire.",
        "requirements": {
            "war_with": ["usa", "uk"],
            "year_min": 1945,
            "world_tension": 90
    ...
    "soviet_occupation": {
        ...
        "description": "The Red Army has swept across Germany, crushing all resistance. The Soviet flag flies over the ruins of Berlin, and Stalin's commissars impose a brutal communist regime. Your leadership has led Germany from one totalitarian system to another.",
        "requirements": {
            "government": "Fascist",
            "at_war_with": ["ussr"],
            "stability": 30,
    ...
    "allied_partition": {
        ...
        "description": "Germany has been utterly defeated by the Allied powers. The country is divided into occupation zones, and its future as a unified nation is uncertain. German sovereignty is a thing of the past as foreign powers determine its fate.",
        "requirements": {
            "government": "Fascist",
    ...
    "economic_collapse": {
        ...
        "description": "Your policies have led to complete economic ruin. Hyperinflation has returned with a vengeance, unemployment is rampant, and the German mark is worthless. Society breaks down as hunger and desperation drive people to extremes.",
        "requirements": {
    ...
    "purge_backfire": {
        ...
        "description": "Your attempts to consolidate power through purges have backfired catastrophically. Military officers, seeing the writing on the wall, staged a coup. You were shot while trying to escape, and Germany now faces an uncertain future under military rule.",
        "requirements": {
            "government": "Communist",
...
def check_endings():
    ...
    # Only check for German endings for now
...
def show_diplomacy():
    ...
    sorted_relations = sorted(
        [(nation_key, relation) for nation_key, relation in game_state["diplomacy"]["relations"].items()],
        key=lambda x: x[1],
        reverse=True
    )
...
def show_game_menu():
    ...
    print_colored("4. Diplomacy", Fore.CYAN)
    print_colored("5. Nation Info", Fore.CYAN)
    print_colored("6. Message Log", Fore.CYAN)
    print_colored("7. Advance Time (1 Month)", Fore.GREEN)
    print_colored("8. Save Game", Fore.MAGENTA)
    print_colored("9. Help", Fore.MAGENTA)
    ...
    if choice == "1":
        ...
        advance_time()
        # Also process research and production
        process_research()
        process_production()
